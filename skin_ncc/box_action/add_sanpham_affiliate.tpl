    ...
    <div class="box_right_content">
        <div class="box_profile">
            <div class="page_title">
                <h1 class="undefined">Đăng sản phẩm Affiliate</h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_50">
                ...
                <div class="form_group">
                    ...
                    <input type="text" class="form_control" name="link_aff" value="" placeholder="Nhập link affiliate...">
                </div>
            </div>
            <div style="clear: both;"></div>
            <div class="col_100">
            ...
            <div style="clear: both;"></div>
            <div class="form_group">
                <button class="button_all" name="add_sanpham_affiliate"> Hoàn thành </button>
            </div>
        </div>
    </div>
</div>
