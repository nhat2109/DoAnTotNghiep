<tr id="tr_{id}">
	...
	<td style="text-align: center;">
		<a href="/ncc/edit-slide?id={id}" class="custom-action-edit edit"><i class="fa fa-edit"></i></a><a href="javascript:;" onclick="confirm_del('del','slide', 'Xác nhận xóa slide', '{id}');" class="del custom-action-delete"><i class="fa fa-trash"></i></a>
	</td>
