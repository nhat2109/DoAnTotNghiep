  ...
  <div class="box_right_content">
  	<div class="box_profile" style="width: 100%;padding: 10px;">
            ...
            <div class="box_timkiem">
                <div class="sanpham_trend"><a href="/ncc/list-sanpham-trend">Click : Sản phẩm Trend để bán</a></div>
                ...
                <button name="timkiem_link_affiliate" class="button_timkiem" kieu="mobile"><i class="fa fa-search"></i></button>
