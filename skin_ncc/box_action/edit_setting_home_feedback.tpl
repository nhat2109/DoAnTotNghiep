...
$(document).ready(function() {
    ...
    $('#addFeedback').click(function () {
        ...
        if ($('.feedback-item').length > 0) {
            template = $('.feedback-item').first().clone();
                ...
                <div class="feedback-item"> 
                    ...
                    <div class="feedback-header">
                        <div class="avatar-preview">
                            ...
                            <input type="file" class="avatar-upload" accept="image/*" style="display: none;" name="avatar[]" value="">
                        </div>
                        <div class="user-info">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="danh_gia[]" min="1" max="5" value="1" required="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
