                ...
                <table class="list_baiviet">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 150px;">Thời gian bán</th>
    ...
    const config = {
        ...
        options: {
            ...
            scales: {
                x: {
                    beginAtZero: true,
                    title: { display: true, text: type === 'bar' ? 'Số lượng bán' : 'Thời gian' }
                },
                y: {
                    beginAtZero: true,
                    title: { display: true, text: type === 'bar' ? 'Tên sản phẩm' : 'Số lượt mua' }
                }
            },
            plugins: {
                ...
                if (info.ok == 1) {
                    ...
                    const htmlBanChay = info.list_banchay.map(item => `
                        <tr>
                            ...
                            <td>${item.tieu_de}</td>
                            <td style="text-align: center;"><img src="${item.minh_hoa}" alt="Ảnh sản phẩm" style="width:50px;height:50px;object-fit:cover;"></td>
                            <td style="text-align: center;">${item.ma_sp}</td>
                            <td style="text-align: center;">${item.ban}</td>
                            <td style="text-align: center;">${item.doanh_thu}</td>
                            <td style="text-align: center;">${item.gia_moi}</td>
                            <td style="text-align: center;">${item.date_post}</td>
                            <td style="text-align: center;">${item.thoi_gian_ban}</td>
