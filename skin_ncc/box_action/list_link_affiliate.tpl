    ...
    <div class="box_right_content">
        <div class="box_profile" style="width: 100%;padding: 10px;">
            ...
            <div class="box_timkiem">
                <div class="sanpham_trend"><a href="/ncc/list-sanpham-trend">Click : Sản phẩm Trend để bán</a>
                </div>
                ...
                <!-- <div class="box_shopcart"><a href="/ncc/add-donhang-drop?step=2"><i class="icon icon-basket"></i>
