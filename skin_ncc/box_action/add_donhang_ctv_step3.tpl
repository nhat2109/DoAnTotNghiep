        ...
        <div class="box_profile" style="width: 800px;padding: 10px;">
            <div class="box_top_profile">
                <div class="box_timkiem">
                    <a href="/ncc/add-donhang-drop?step=2"><button class="button_timkiem" style="border-radius: 5px;"><i class="fa fa-angle-double-left"></i> Quay lại</button></a>
                </div>
            ...
            <div class="box_order_info">
                <div class="box_order_info_left box_order_info_left_bt">
                    ...
                    <div class="box_button">
                        <button class="button_hoanthanh bg_green" name="button_hoanthanh_ncc">Hoàn thành</button>
                    </div>
                </div>
