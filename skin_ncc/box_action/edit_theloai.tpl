    ...
    <div class="box_right_content">
        <div class="box_profile">
            <div class="page_title">
                <h1 class="undefined">Chỉnh sửa danh mục bài viết</h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_50">
                ...
                <div class="form_group">
                    ...
                    <input type="text" class="form_control tieude_seo" name="cat_tieude" onkeyup="check_blank('theloai');" value="{cat_tieude}" placeholder="Nhập tiêu đề...">
                </div>
                <div class="form_group">
                    <label for="">Link xem</label>
                    <input type="text" class="form_control link_seo" name="cat_blank" onkeyup="check_link('theloai');" value="{cat_blank}" placeholder="Nhập link xem...">
                    <input type="hidden" name="link_old" id="link_old" value="{cat_blank}">
                    <div class="check_link"></div>
                </div>
                <div class="form_group" style="display: none;">
                    <label for="">Nội dung</label>
                    <textarea name="cat_noidung" class="form_control" placeholder="Nhập nội dung danh mục" style="width: 100%;height: 95px;">{cat_noidung}</textarea>
                </div>
                <div class="form_group">
