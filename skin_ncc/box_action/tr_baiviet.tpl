<tr id="tr_{id}">
	...
	<td style="text-align: center;">
		<a href="/ncc/edit-post?id={id}" class="edit custom-action-edit"><i class="fa fa-edit"></i></a><a href="javascript:;" onclick="confirm_del('del','baiviet', 'Xác nhận xóa bài viết', '{id}');" class="del custom-action-delete"><i class="fa fa-trash"></i></a>
	</td>
</tr>
