        ...
        <div class="box_right_content">
            <div class="box_profile">
                <div class="page_title">
                    <h1 class="undefined">Thông tin NCC</h1>
                    <div class="text_muted">Đổi thông tin NCC và liên hệ</div>
                    <div class="line"></div>
                    <hr>
                </div>
                <div class="col_100">
                    ...
                    <div class="form_group">
                        ...
                        <input type="text" class="form_control" name="ten_daidien" value="{ten_daidien}" placeholder="Nhập tên người đại diện...">
                    </div>
                    <div class="form_group">
                        <label for="">Chức vụ</label>
                        <input type="text" class="form_control" name="chucvu" value="{chucvu}" placeholder="Nhập chức vụ...">
                    </div>
                    <div class="form_group">
