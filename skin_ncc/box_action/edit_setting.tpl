  	...
  	<div class="box_profile">
		...
		<div class="col_100">
	      <div class="form_group">
	        ...
	        <textarea name="content" class="form_control" placeholder="Nhập nội dung..." style="width: 100%;height: 250px;">{value}</textarea>
	      </div>
		</div>
		<div style="clear: both;"></div>
		<div class="col_100">
		...
		<div class="form_group">
			...
			<button class="button_all" name="edit_setting_text"> Hoàn thành </button>
		</div>
  	</div>
  </div>
</div>