...
<body>
  <div class="loadpage">
    <div class="content_loadpage">
      <div class="logox">
        <a href="/dropship/dashboard"><img src="/skin_dropship/css/images/logo.png" alt="logo"></a>
      </div>
      <div class="loadx"></div>
    </div>
  </div>
  <div class="page_body">
    ...
    <div class="menu_top">
      <div class="menu_top_left">
        <div class="drop_down" style="width: 90px;">
      ...
      <div class="menu_top_center">
        <input style="margin-left: 0px;" type="text" name="key_hieu" class="search_input"
      ...
      <div class="menu_top_right">
          ...
          <div class="list_notification">
            <div class="tab_notification">
              ...
              <div class="li_tab active" id=""><a style="color: #ffffff !important;"
                  href="/dropship/list-thongbao">Thông báo mới</a><span style="color: #333;margin-left:4px;"
                  class="total_thongbao">0</span></div>
              <div class="li_tab active" id=""><a style="color: #ffffff !important;"
                  href="/dropship/list-sanpham-tuan">Chương trình tuần</a><span style="color: #333;margin-left:4px;"
                  class="total_ct_tuan">0</span></div>
              <div class="li_tab active" id=""> <a style="color: #ffffff !important;"
                  href="/dropship/list-sanpham-hethang-catma">Sắp cắt mã</a><span style="color: #333;margin-left:4px;"
                  class="total_catma">0</span></div>
              <div class="li_tab active" id=""><a style="color: #ffffff !important;"
                  href="/dropship/list-sanpham-hethang">Sắp hết hàng</a><span style="color: #333;margin-left:4px;"
        ...
        <div style="margin-left: 5px;" class="avatar hide_mobile">
          <a href="/dropship/list-sanpham-follow">
            <img src=""
        ...
        <div class="drop_down">
          ...
          <div class="drop_menu" style="width: 200px;">
            ...
            <div class="line"></div>
            <a class="drop_item" href="/dropship/profile"><i class="icon icon-profile"></i> Profile</a>
            <div class="line"></div>
            <a class="drop_item text_danger" href="/dropship/logout"><i class="mr-3 icon icon-switch"></i> Đăng xuất</a>
          </div>
        </div>

        <div class="avatar hide_mobile"><a href="/dropship/profile"><img style="border: 2px solid rgb(234, 141, 141);"
              src="{avatar}" alt="avatar" onerror="this.src='/images/user.png';"></a>
        </div>
        <div class="avatar hide_mobile box_shopcart">
          <a href="/dropship/add-donhang-drop?step=2">
    ...
    <div class="box_left">
      <div class="box_menu_left scroll">
        <div class="logo">
          <a href="/dropship/dashboard"><img src="/skin_dropship/css/images/logo_white.png" alt="logo"></a>
        </div>
  ...
  <div id="popup_lo_trinh_mobile">
    <div class="popup-header">
      <h3>Nhà bán hàng</h3>
      <img src="/images/socdo.png" alt="">
      <button class="close-button"
        onclick="document.getElementById('popup_lo_trinh_mobile').style.display='none'">&times;</button>
    </div>
    <div class="toggle-container">
      ...
      <div class="toggle-content">
        <ul>
          ...
          <li><a href="#" class="trigger_small_popup" data-target="popup_banhang1cham">Bán hàng 1 chạm như thế nào ?</a>
          </li>
    ...
    <div class="tree-container">
      <div class="tree-branches">
        <div class="branch">
          <h4><a href="/dropship/nhiemvu-nguoimoi">Bán hàng bằng nhân hiệu cá nhân</a></h4>
          <ul>
            <li><a href="#">Zalo, Facebook, Instagram</a></li>
            <li><a href="#">Xây dựng - Phát triển thương hiệu cá nhân</a></li>
            <li><a href="#">Bán hàng 1 chạm siêu dễ dàng</a></li>
          </ul>
        </div>
        <div class="branch">
          <h4> <a href="#" class="trigger_small_popup" data-target="popup_suckien">
              Sự nghiệp trọn đời : Nhà bán hàng Chuyên Nghiệp</a></h4>
          <ul>
            <li><a href="#">Hoa hồng liên kết: 200.000 VNĐ/User</a></li>
            <li><a href="#">Thưởng 5% hoa hồng nhóm Nhà Bán</a></li>
            <li><a href="#">Thưởng 1.5 triệu cho Nhà Bán lên NBCN</a></li>
            <li><a href="#">Thưởng 1.5% nhóm nhà bán CN</a></li>
          </ul>
        </div>
        <div class="branch">
          <h4><a href="#" class="trigger_small_popup" data-target="popup_bansan">Bán hàng trên sàn thương mại điện
              tử</a>
          </h4>
          <ul>
            <li><a href="#">Lazada, Shopee, TikTok</a></li>
            <li><a href="/dropship/list-dichvu#bo-template">Cung cấp Template chuyên nghiệp</a></li>
            <li><a href="/dropship/list-dichvu#setup-gian-hang">Setup gian hàng chuyên nghiệp</a></li>
            <li><a href="/dropship/list-dichvu#coppy-san-pham">Sao chép và trang trí sản phẩm</a></li>
            <li><a href="/dropship/list-dichvu#seeding-shopee">Wow Seeding 🗣️</a></li>
            <li><a href="/dropship/list-idol">🎬 Book lịch LiveStream</a></li>
          </ul>
        </div>
        <div class="branch">
          <h4><a href="/dropship/list-dichvu#bo-template">Bán hàng qua Website chuyên nghiệp</h4>
          <ul>
            <li><a href="/dropship/domain">Tích hợp tên miền riêng</a></li>
            <li><a href="/dropship/list-giaodien">Mẫu Template hiện đại</a></li>
            <li><a href="#">Kênh marketing đầy đủ tính năng</a></li>
            <li><a href="/dropship/add-sanpham-ngoai">Tự kinh doanh sản phẩm riêng</a></li>
            <li><a href="#">Dễ dàng làm Affiliate đa nền tảng</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div id="popup_lo_trinh">
    <div class="popup_content">
      ...
      <div class="section_box_top">
        ...
        <div class="text_top">
          <div class="content" style="margin-left: 35px;">
            ...
            <h3 style="position: relative;"> <a href="/dropship/nhiemvu-nguoimoi">Bán hàng bằng nhân
                hiệu các nhân</a>
      ...
      <div class="section_box_mid">
        ...
        <div class="box-one flex-row" style="display: flex;">
          ...
          <div class="text-mid-3">
            <p><a href="/dropship/list-dichvu#bo-template">Cung cấp Template chuyên nghiệp <i class="fa fa-cog"></i>
              </a></p>
            <p><a href="/dropship/list-dichvu#setup-gian-hang">Setup <i class="fa fa-cog"></i>
                gian hàng <br> chuyên nghiệp</a></p>
            <p><a href="/dropship/list-dichvu#coppy-san-pham">Sao chép và trang trí sản phẩm</a></p>
            <p><strong><a href="/dropship/list-dichvu#seeding-shopee">Wow Seeding</a> <br></strong>🗣️</p>
            <p><a href="/dropship/list-idol">🎬 Book lịch <br>
                LiveStream</a></p>
      ...
      <div class="section_box_bottom">
        ...
        <div class="box_2">
          <p><a href="/dropship/domain">Tích hợp <br><strong>tên miền</strong> riêng</a></p>
          <h3><a href="/dropship/list-giaodien">Bán hàng qua<br> Website chuyên nghiệp</a></h3>
          <p><a href="/dropship/list-giaodien">Mẫu<strong>Template</strong><br>hiện đại</a><i class="user_icon"></i>
          </p>
        </div>
        <div class="box_3">
          <p> <a href="">Kênh maketting đầy <br> đủ tính năng</a></p>
          <p> <a href="/dropship/add-sanpham-ngoai">Tự kinh doanh <br>sản phẩm riêng</a></p>
...
<style>
  ...
  @media screen and (max-width: 768px) {
    ...
    #popup_lo_trinh_mobile {
      ...
      overflow-y: auto;
      overflow-x: hidden;
      border: 4px solid #63ACFF;
    }

    /* Overlay nếu cần */
    #popup_mobile_overlay {
      display: block;
      /* Hiển thị để kiểm tra */
      position: fixed;
      top: 0;
    ...
    /* Thiết kế tổng thể cho toggle container */
    .toggle-container {
      margin-top: 15px;
      position: relative;
      z-index: 1;
    ...
    /* Khi mở nội dung, mũi tên xoay lên */
    ...
    .toggle-content.show {
      max-height: 500px;
      /* Đặt chiều cao tối đa đủ lớn để chứa nội dung */
      opacity: 1;
      transform: scaleY(1);
    }
...
<script>
  $(document).ready(function () {
    $('.lo_trinh_btn').on('click', function (e) {
      ...
      if (windowWidth <= 768) {  // Điều kiện cho mobile, bạn có thể điều chỉnh ngưỡng này
        $('#popup_lo_trinh_mobile').fadeIn();
      } else {
    ...
    // Đóng popup cho desktop (với overlay và nút đóng bên trong popup)
    $('#popup_overlay, #popup_lo_trinh .close_popup').on('click', function () {
      $('#popup_overlay').fadeOut();
      $('#popup_lo_trinh').fadeOut();
    });

    // Nếu cần đóng popup mobile, thêm xử lý cho phần tử bên trong popup mobile (nếu có nút đóng)
    $('#popup_lo_trinh_mobile .close_popup').on('click', function () {
      $('#popup_lo_trinh_mobile').fadeOut();
    });
  });
...
<style>
  @media (min-width:1200px) {
    ...
    .page_body .list_donhang_top .li_donhang {
      width: 100%;
      display: flex;
      flex-wrap: wrap;
      margin-top: 11px;
