    ...
    <div class="box_right_content">
        <div class="box_profile">
            <div class="page_title">
                <h1 class="undefined">Chỉnh sửa danh mục sản phẩm</h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_50">
                ...
                <div class="form_group">
                    <label for="">Banner <span class="color_red">(Kích thước 288x590 pixcel)</span></label>
                ...
                <div class="form_group">
                    ...
                    <textarea name="cat_description" class="form_control" placeholder="Nhập mô tả danh mục" style="width: 100%;height: 95px;">{cat_description}</textarea>
                </div>
                <div class="form_group">
