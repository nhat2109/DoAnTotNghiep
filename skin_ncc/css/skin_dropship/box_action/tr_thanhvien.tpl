<tr id="tr_{user_id}">
	...
	<td style="text-align: center;">
		<a href="/dropship/edit-thanhvien?id={user_id}" class="edit">Chi tiết</a><a href="javascript:;" onclick="confirm_del('del','thanhvien', 'Xác nhận xóa thành viên', '{id}');" class="del">xóa</a>
	</td>
</tr>