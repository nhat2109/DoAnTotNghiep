...
<script src="/js/process_dropship.js?t=<?php echo time();?>"></script>
            ...
            <div class="tfoot-popup">
                ...
                <div class="tfoot-popup-2 clearfix">
                    <a class="button btn-proceed-checkout" title="Thanh toán đơn hàng"
                        href="/dropship/add-donhang-drop?step=2"><span>Giỏ hàng của bạn</span></a>
                </div>
            </div>
        </div>
...
<div class="box_sms_bottom">
    <div class="box_sms_bottom_content"><a href="/dropship/list-chat"><img src="/images/icon-nu.png"><span
...
<div class="add_cart_fixed">
    <a href="/dropship/add-donhang-drop"><i class="icon icon-cart-add"></i></a>
    <div class="box_huongdan">
        <div class="muiten right"><i class="fa fa-caret-up"></i></div>
