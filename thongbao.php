...
$replace=array(
	...
	'list_thongbao'=>$class_index->list_thongbao($conn,$user_id,$page,$limit),
...
if($user_info['dropship']>0 OR $user_info['ctv']>0){
	echo $skin->skin_replace('skin/thongbao_dropship',$replace);
}else{
	echo $skin->skin_replace('skin/thongbao',$replace);	
}
?>