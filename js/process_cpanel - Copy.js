...
/*        $('.load_overlay').show();
    ...
    $('button[name=add_flash_sale]').click(function() {
        ...
        $('#list_product_sub .li_product').each(function(){
            ...
            s++;
            if(s==product_length){
                list+= '"'+sp_id+'":{"gia":"'+gia+'","so_luong":"'+so_luong+'","date_start":"'+date_start+'","date_end":"'+date_end+'"}';
            }else{
                list+= '"'+sp_id+'":{"gia":"'+gia+'","so_luong":"'+so_luong+'","date_start":"'+date_start+'","date_end":"'+date_end+'"},';
            }
            if(gia==''){
    ...
    $('.button_add_phanloai').on('click', function() {
        $('.list_phanloai').append('<div class="li_phanloai"><div class="info_ma"><input type="text" name="ma[]" placeholder="Mã"></div><div class="info_name"><input type="text" name="size[]" size="" placeholder="Kích cỡ"><div class="list_goiy scroll"></div></div><div class="info_mau"><input type="text" name="color[]" color="" placeholder="Màu sắc"><div class="list_goiy scroll"></div></div><div class="info_can_nang"><input type="text" name="can_nang[]" placeholder="Trọng lượng"></div><div class="info_gia"><input type="text" name="gia_cu[]" placeholder="Giá cũ"></div><div class="info_gia"><input type="text" name="gia_moi[]" placeholder="Giá bán"></div><div class="info_gia"><input type="text" name="gia_drop[]" placeholder="Giá Drop"></div><div class="info_gia"><input type="text" name="drop_min[]" placeholder="Giá tối thiểu"></div></div>');
    });
    ////////////////
...
/*                    var dulieu={
    ...
    $('button[name=add_sanpham]').on('click', function() {
        ...
        gia_ctv = $('input[name=gia_ctv]').val();
        can_nang = $('input[name=can_nang]').val();
        ...
        var list_ma_sanpham = '';
        $('.li_ma').each(function() {
            ma_sanpham = $(this).find('input[name^=ma_sanpham]').val();
            mau = $(this).find('input[name^=ma_sanpham]').attr('mau');
            ten_mau = $(this).find('span').html();
            list_ma_sanpham += mau + '&&' + ten_mau + '&&' + ma_sanpham + '|';
        });
        var list_cat = [];
        ...
        if (tieu_de.length < 4) {
            ...
            $('input[name=gia_drop]').focus();
        } else if (drop_min == '') {
            $('input[name=drop_min]').focus();
        } else if (gia_ctv == '') {
            $('input[name=gia_ctv]').focus();
        } else if (can_nang == '') {
            $('input[name=can_nang]').focus();
            ...
            form_data.append('gia_ctv', gia_ctv);
            form_data.append('can_nang', can_nang);
            ...
            form_data.append('ma_sanpham', list_ma_sanpham);
