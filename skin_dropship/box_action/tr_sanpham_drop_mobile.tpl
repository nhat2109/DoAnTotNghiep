...
<div class="li_sanpham_drop" id="tr_{id}">
	<div class="minh_hoa"><a href="/product/{link}.html" target="_blank"><img src="/thumbnail.php?w=320&img={minh_hoa}"
				width="200"></a></div>
	...
	<div class="info_sanpham">
		...
		<div class="right">
			<div class="list_action">
				...
				<a href="/dropship/list-share-sanpham?id={id}" class="flex share_facebook" sp_id="{id}"><span>Đăng
						bán</span><img src="/images/fb_zalo.png"></a>
				<a href="javascript:;" class="edit bg_orange in_line add_follow" sp_id="{id}"
					style="margin-top: 0px;"><i class="fa {class_follow}"></i> Yêu thích</a>
