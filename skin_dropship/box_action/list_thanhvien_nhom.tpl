...
<div class="page_body">
	<div class="box_right box_right_mobile">
		<div class="container">
					...
					<div class="box_profile" style="width: 100%;padding: 10px;">
						...
						<div class="box_result">
							<div class="li_box">
								...
								<a href="/dropship/list-thunhap-nhom?loai=nhaban-chuyennghiep&page=1">
							...
							<div class="li_box">
								...
								<a href="/dropship/list-thunhap-nhom?loai=doanhthu-nhom&page=1">
									<div class="li_box_content">
										<div class="li_box_left">
							...
							<div class="li_box">
								...
								<a href="/dropship/list-thunhap-nhom?loai=thunhap-nhaban&page=1">
									<div class="li_box_content">
										<div class="li_box_left">
			...
			<div class="box_content box_tien_nhom active" style="height: 700px;">
				<div class="box_right_content">
					<div class="box_profile" style="width: 100%; padding: 10px">
						<div class="box_time">
							<h2>Chọn khoảng thời gian</h2>
			...
			<!-- Box Đơn Hàng Xử Lý -->
			<div class="box_content box_donhang_xuly" style="height: 750px;">
				<div class="box_right_content">
					<div class="box_profile" style="width: 100%; padding: 10px">
						<div class="box_time">
							<h2>Chọn khoảng thời gian</h2>
			...
			<div class="box_theongay_thang box_content" style="height: 1400px; width:100% !important;">
				<div class="box_right_content">
					<div class="box_profile" style="width: 100%;padding: 10px;">
						...
						<h1>Đơn hàng của <span class="color_green">{tieu_de}</span> tuần thứ {tuan}({ngay_dau_tuan} -
							{ngay_cuoi_tuan})</h1>
						<div class="chart">
							<figure class="highcharts-figure">
...
<style>
	...
	#doanhthuChart {
		max-height: 400px;
		/* Điều chỉnh theo kích thước của biểu đồ tròn */
	}
	...
	.drop_status input[type="radio"] {
		...
		/* Không cho click */
		opacity: 0.6;
		/* Làm mờ một chút để hiển thị chỉ xem */
	}
</style>
<script>
	$(document).ready(function () {
...
<style>
	...
	h3 {
		all: unset !important;
		/* Reset tất cả thuộc tính về mặc định */
