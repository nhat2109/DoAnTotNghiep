<div class="box_right">
  <div class="box_right_content">
  	<div class="box_profile" style="width: 100%;padding: 10px;">
        <div class="list_tab">
            <div class="li_tab" loai="drop"><a href="/dropship/list-donhang-nhom?loai=drop&status={status}&page=1">Đơn sàn TMĐT</a></div>
            <div class="li_tab" loai="socdo"><a href="/dropship/list-donhang-nhom?loai=socdo&status={status}&page=1">Đơn SOCDO.VN</a></div>
            <div class="li_tab" loai="affiliate"><a href="/dropship/list-donhang-nhom?loai=affiliate&status={status}&page=1">Đơn Affiliate</a></div>
        </div>
