                    ...
                    <div style="width: 100%;">
                        ...
                        <div class="dieukhoan">
                            ...
                            <div class="dieukhoan_content">
                                <ul>
                                    <li>1. Sóc đỏ đại diện Drop đăng ký tên miền trên hệ thống</li>
                                    <li>2. Tên miền thuộc sở hữu của Drop và Sóc đỏ không được phép sử dụng vì mục đích riêng</li>
                                    <li>3. Sóc đỏ hỗ trợ đăng ký tên miền và cài đặt</li>
                                    <li>4. Tên miền sẽ được gia hạn hằng năm theo yêu cầu của Drop</li>
                                </ul>
                            </div>
                        </div>
                    </div>
