        ...
        <div class="box_profile">
            ...
            <div class="col_50">
                <div class="form_group">
                    ...
                    <input type="text" class="form_control" name="tieu_de" value="" placeholder="Nhập tên thương hiệu...">
                </div>
                <div class="form_group">
                ...
                <div class="form_group">
                    ...
                    <input type="text" class="form_control" name="link_anh" value="" placeholder="Nhập link ảnh...">
                </div>
                <div class="form_group">
