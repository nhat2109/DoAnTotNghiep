    ...
    <div class="box_right_content">
        <div class="box_profile" style="width: 1000px;">
            <div class="page_title">
                <h1 class="undefined">Thêm video mới</h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_50">
                ...
                <div class="form_group">
                    ...
                    <input type="text" class="form_control" name="link_video" value="" placeholder="Nhập link video youtube...">
                </div>
                <div class="form_group">
            ...
            <div class="col_100">
                ...
                <div class="form_group">
                    ...
                    <textarea name="content" class="form_control" id="edit_textarea" placeholder="Nhập nội dung hướng dẫn" style="width: 100%;height: 250px;"></textarea>
                ...
                <div class="form_group">
                    ...
                    <textarea name="description" class="form_control" placeholder="Nhập mô tả hướng dẫn" style="width: 100%;height: 95px;"></textarea>
                </div>
                <div class="form_group">
            ...
            <div style="clear: both;"></div>
            <div class="form_group">
                <button class="button_all" name="add_video"> Hoàn thành </button>
            </div>
        </div>
    </div>
</div>
