    ...
    <div class="box_right_content">
        <div class="box_profile" id="tab_thongtin_content" style="width: 100%;padding: 10px;">
            ...
            <div class="list_tab_member">
                ...
                <div class="li_tab_member" id="tab_thanhvien_nhom_chuyennghiep">Thành viên nhóm</div>
                <div class="li_tab_member" id="tab_donhang_nhom_chuyennghiep">Đơn sàn TMĐT nhóm</div>
                <div class="li_tab_member" id="tab_donhang_nhom_socdo_chuyennghiep">Đơn CTV nhóm</div>
            </div>
            <div class="list_tab_content">
                    ...
                    <div style="width: 50%;">
                        ...
                        <div class="list_group group_3">
                            <div class="form_group">
                                ...
                                <input type="text" class="form_control" name="maso_thue" value="{maso_thue}" placeholder="Nhập mã số thuế...">
                            </div>
                            <div class="form_group">
                                <label for="">Ngày cấp</label>
                                <input type="text" class="form_control" name="maso_thue_cap" value="{maso_thue_cap}" placeholder="Nhập ngày cấp...">
                            </div>
                            <div class="form_group">
                        ...
                        <div class="form_group">
                            <label for="">Nhà viên sóc đỏ</label>
                            <select class="form_control" name="nhan_vien">
                                <option value="1">Có</option>
                                <option value="0">Không</option>
                            </select>
                        </div>
                        <div class="form_group">
                            <label for="">Nhà bán hàng</label>
                            <select class="form_control" name="dropship">
                                <option value="1">Có</option>
                                <option value="0">Không</option>
                            </select>
                        </div>
                        <div class="form_group">
                            <label for="">Nhà bán hàng chuyên nghiệp</label>
                            <select class="form_control" name="leader">
                                <option value="1">Có</option>
                                <option value="0">Không</option>
                            </select>
                        </div>
                ...
                <div class="li_tab_content" id="tab_thanhvien_nhom_chuyennghiep_content" page="1" load="1">
                    <table class="list_baiviet">
                        <tr>
                            <th style="text-align: center;width: 50px;" class="hide_mobile">STT</th>
                ...
                <div class="li_tab_content" id="tab_donhang_nhom_chuyennghiep_content" page="1" load="1">
                    <table class="list_baiviet">
                        <tr>
                            <th style="text-align: center;width: 50px;" class="hide_mobile">STT</th>
                            <th style="text-align: left;">Mã đơn</th>
                ...
                <div class="li_tab_content" id="tab_donhang_nhom_socdo_chuyennghiep_content" page="1" load="1">
                    <table class="list_baiviet">
                        <tr>
                            <th style="text-align: center;width: 50px;" class="hide_mobile">STT</th>
                            <th style="text-align: left;">Mã đơn</th>
...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        $('select[name=nhan_vien]').val(nhan_vien); 
        var dropship='{dropship}';
        $('select[name=dropship]').val(dropship); 
        var leader='{leader}';
        $('select[name=leader]').val(leader); 
