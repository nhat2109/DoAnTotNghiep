    ...
    <div class="box_right_content">
        <div class="box_profile">
            ...
            <div class="col_50">
                ...
                <div class="form_group">
                    ...
                    <div class="cover" style="cursor: pointer;">
                        <img src="{cover}" onerror="this.src='/images/no-images.jpg';" width="200" id="preview-cover" title="click để chọn ảnh">
                    </div>
            ...
            <div class="form_group">
                ...
                <button name="edit_banner_qc" class="button_all"> Thêm </button>
            </div>
        </div>
    </div>
</div>
