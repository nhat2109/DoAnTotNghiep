  ...
  <div class="box_right_content">
  	<div class="box_profile" style="width: 100%;padding: 10px;">
  		<div class="box_timkiem">
  			<a href="/admincp/add-noidung-nhiemvu?id={id}"><button class="bg_green" style="border-radius: 5px;"><i class="fa fa-plus"></i> Thêm nội dung</button></a>
  		</div>
		<div class="page_title">
		    <h1 class="undefined">Nội dung "{tieu_de}"</h1>
		    <div class="line"></div>
		    <hr>
		</div>
