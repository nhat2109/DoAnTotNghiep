                ...
                <div class="form_group">
                    ...
                    <div class="list_phanloai">
                        ...
                        <div class="li_phanloai">
                            ...
                            <div class="info_gia">
                                <input type="text" name="gia_drop[]" class="price_format" placeholder="Giá Drop">
                            </div>
                            <div class="info_gia">
                                <input type="text" name="gia_ctv[]" class="price_format" placeholder="Giá CTV">
                            </div>
                            <div class="info_gia">
                                <input type="text" name="drop_min[]" class="price_format" placeholder="Giá tối thiểu">
                            </div>
