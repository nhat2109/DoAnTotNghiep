            ...
            <div class="col_50">
                ...
                <div class="form_group">
                    ...
                    <div class="mh_minhhoa" style="cursor: pointer;">
                        <img src="{cat_minhhoa}" onerror="this.src='/images/no-images.jpg';" width="200" id="preview-cat-minhhoa" title="click để chọn ảnh">
                    </div>
...
<script type="text/javascript">
    ...
    var cat_trend ='{cat_trend}';
    var cat_noibat ='{cat_noibat}';
    $("input[name=cat_index][value=" + cat_index + "]").prop('checked', true);
    $("input[name=cat_trend][value=" + cat_trend + "]").prop('checked', true);
    $("input[name=cat_noibat][value=" + cat_noibat + "]").prop('checked', true);
</script>
<script type="text/javascript">
