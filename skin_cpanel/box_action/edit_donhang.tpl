        ...
        <div class="box_profile">
            ...
            <div class="col_50">
                ...
                <div class="form_group">
                    ...
                    <select class="form_control" name="status">
                        ...
                        <option value="3">Yêu cầu hủy đơn Drop</option>
            ...
            <div class="col_100">
                ...
                <div class="form_group">
                    ...
                    <a href="{minh_hoa}" target="_blank" style="display: inline-block;padding-left: 20px;padding-right: 20px;padding-bottom: 3px;padding-top: 3px;color: #fff;border-radius: 5px;" class="bg_green">Tải về</a>
                </div>
                <div class="form_group">
