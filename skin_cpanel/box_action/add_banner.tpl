    ...
    <div class="box_right_content">
        <div class="box_profile">
            <div class="page_title">
                <h1 class="undefined">Thêm banner mới</h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_50">
                ...
                <div class="form_group">
                    ...
                    <input type="color" class="form_control" name="bg_banner" value="" placeholder="Nhập màu nên banner...">
                </div>
                <div class="form_group">
                    <label for="">Liên kết</label>
                    <input type="text" class="form_control" name="link" value="" placeholder="Nhập liên kết slide...">
                </div>
                <div class="form_group">
            ...
            <div style="clear: both;"></div>
            <div class="form_group">
                <button name="add_banner" class="button_all"> Thêm </button>
            </div>
        </div>
    </div>
</div>
