  ...
  <div class="box_right_content">
  	<div class="box_profile" style="width: 100%;padding: 10px;">
		<div class="page_title">
		    <h1 class="undefined">Danh sách giao diện</h1>
		    <div class="line"></div>
		    <hr>
		</div>
		<table class="list_baiviet">
			<tr>
				...
				<th style="text-align: center;width: 100;">Giá niêm yết</th>
				<th style="text-align: center;width: 100">Giá áp dụng</th>
				<th style="text-align: center;" class="hide_mobile">Link demo</th>
