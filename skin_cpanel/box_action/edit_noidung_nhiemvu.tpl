    ...
    <div class="box_right_content">
        <div class="box_profile" style="width: 800px;">
            <div class="page_title">
                <h1 class="undefined">Sửa nội dung nhiệm vụ "ngày {ngay}"</h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_50">
            ...
            <div class="form_group">
                ...
                <input type="hidden" name="nhiemvu_id" value="{nhiemvu_id}">
                <button class="button_all" name="edit_noidung_nhiemvu"> Hoàn thành </button>
            </div>
        </div>
    </div>
</div>
