    ...
    <div class="box_right_content">
        <div class="box_profile">
            <div class="page_title">
                <h1 class="undefined">Thêm coupon mới</h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_50">
                <div class="form_group">
                    ...
                    <input type="text" class="form_control" name="ma" value="" placeholder="Viết liền, không dấu...">
                </div>
                <div class="form_group">
                ...
                <div class="form_group">
                    ...
                    <input type="text" class="form_control price_format" name="dieu_kien" value="" placeholder="Nhập giá trị đơn hàng áp dụng...">
                </div>
                <div class="form_group">
