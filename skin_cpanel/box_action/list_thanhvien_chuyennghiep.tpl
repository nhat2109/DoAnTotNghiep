  ...
  <div class="box_right_content">
  	<div class="box_profile" style="width: 100%;padding: 10px;">
  		<div class="box_timkiem">
  			...
  			<button name="timkiem_thanhvien_chuyennghiep" class="button_timkiem">Tìm kiếm</button>
  		</div>
		<div class="page_title">
		    <h1 class="undefined">Danh sách thành viên chuyên nghiệp</h1>
		...
		<table class="list_baiviet">
			<tr>
				...
				<th style="text-align: center;" class="hide_mobile">Thành viên</th>
				<th style="text-align: center;width: 350px;">Ngày đăng ký</th>
				<th style="text-align: center;width: 180px;">Hành động</th>
			</tr>
			{list_thanhvien_chuyennghiep}
		</table>
		{phantrang}
  	</div>
  </div>
