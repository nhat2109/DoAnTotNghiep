<?php
			...
			echo json_encode(array('ok' => 1, 'list_shopcart' => $list_shopcart, 'list_shopcart_mobile' => $list_shopcart_mobile, 'total_cart' => count((array)$_SESSION['drop_cart']), 'tongtien' => $total_price, 'thongbao' => 'Thêm vào giỏ hàng thành công'));
?>