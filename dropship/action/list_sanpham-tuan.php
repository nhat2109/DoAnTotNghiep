<?php
	...
	$bien = array(
		...
		'phantrang' => $class_index->phantrang($page, $total_page, '/dropship/list-sanpham-tuan'),
	);
	$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/list_sanpham_tuan', $bien);
?>