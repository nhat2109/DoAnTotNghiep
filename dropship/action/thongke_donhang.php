<?php
	...
	$bien = array(
		...
		'data_nam' => $class_index->thongke_donhang_nam($conn, $user_id, $ngay_dau, $ngay_cuoi),
		'list_ngay' => $list_ngay,
		'data_thang' => $class_index->thongke_donhang_thang($conn, $user_id, $thangnay, $namnay, $ngay_dau_thang, $ngay_cuoi_thang),
		'data_tuan' => $class_index->thongke_donhang_tuan($conn, $user_id, $ngay_dau_tuan, $ngay_cuoi_tuan),
	);
	$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/thongke_donhang', $bien);
?>