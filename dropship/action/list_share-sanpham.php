<?php
	...
	$bien=array(
		...
		'phantrang'=>$class_index->phantrang_timkiem($page,$total_page,'/dropship/list-share-sahsanpham?id='.$id)
	);
	$thaythe['box_right']=$skin->skin_replace('skin_dropship/box_action/list_share_sanpham',$bien);
?>