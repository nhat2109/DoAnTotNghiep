<?php 
	...
	if ($step == 2) {
		...
		$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/list_giaodien_step2', $r_tt);
	} else {
		$thaythe['title'] = 'Thiết lập giao diện';
		$thaythe['title_action'] = 'Thiết lập giao diện';
		...
		$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/list_giaodien', $r_tt);
	}
?>