<?php
	...
	if ($r_tt['total'] == 0) {
		...
		$replace = array(
			...
			'thongbao' => $thongbao,
			'link_chuyen' => '/dropship/list-setting',
		);
		echo $skin->skin_replace('skin_dropship/chuyenhuong', $replace);
		exit();
	}
	if ($r_tt['loai'] == 'img') {
		$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/edit_setting_img', $r_tt);
		...
		if($r_tt['name']=='home_feature')
		{
			...
			$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/edit_setting_home_feature', $r_tt);//7-4
		} 
		else if($r_tt['name']=='feedback_shop')
		{
			...
			unset($r_tt['value']);
			$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/edit_setting_home_feedback', $r_tt);
		}
		else{
			$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/edit_setting_html', $r_tt);
		}
		...
		$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/edit_setting_css', $r_tt);
	} else {
		$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/edit_setting', $r_tt);
	}
?>