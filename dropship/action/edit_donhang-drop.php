<?php
	...
	if ($r_tt['total'] == 0) {
		...
		$replace = array(
			...
			'thongbao' => $thongbao,
			'link_chuyen' => '/dropship/list-donhang-dropship',
		);
	...
	$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/edit_donhang_drop', $r_tt);
?>