<?php
	...
	if($check->is_mobile()==true){
		$bien = array(
			...
			'phantrang' => $class_index->phantrang($page, $total_page, '/dropship/list-sanpham-trend'),
		);
		$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/list_sanpham_trend_mobile', $bien);
	}else{
		$bien = array(
		...
		$thaythe['box_right'] = $skin->skin_replace('skin_dropship/box_action/list_sanpham_trend', $bien);
	}
?>