...
if (!isset($_COOKIE['emin_id'])) {
    ...
    if(strlen($tieu_de)<2){
        ...
        mysqli_query($conn,"UPDATE seeding_shopee_ncc SET tieu_de='$tieu_de',thoi_gian='$thoi_gian',gia='$gia',gia_cu='$gia_cu',uu_dai='$uu_dai',loai='$loai',thu_tu='$thu_tu' WHERE id='$id'");
        $ok=1;
