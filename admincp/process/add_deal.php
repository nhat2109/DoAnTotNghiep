...
if ($tieu_de == '') {
    ...
    mysqli_query($conn, "INSERT INTO deal(shop,tieu_de,main_product,sub_product,sub_id,date_start,date_end,loai,date_post)VALUES('0','$tieu_de','$main_product','$list_product','$list_id','$start','$end','$loai'," . time() . ")");
}
$info = array(
    'ok' => $ok,
    'thongbao' => $thongbao
