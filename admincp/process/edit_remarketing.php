...
if (!isset($_COOKIE['emin_id'])) {
    ...
    $thongtin = mysqli_query($conn, "SELECT * FROM thongbao_shop WHERE id='$id'");
    ...
    mysqli_query($conn,"UPDATE thongbao_shop SET tieu_de='$tieu_de',noi_dung='$noidung',minh_hoa='$minh_hoa',img_pop='$img_pop',pop='$pop',nhan='$member_id' WHERE id='$id' AND shop='0'");
    $ok=1;
