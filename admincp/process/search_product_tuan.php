...
$hientai=time();
$thongtin=mysqli_query($conn,"SELECT * FROM sanpham sp WHERE $where AND (SELECT count(*) FROM sanpham_tuan st WHERE st.sp_id=sp.id AND st.time_end>='$hientai')='0' ORDER BY id DESC");
$i=0;
