...
if (!isset($_COOKIE['emin_id'])) {
    ...
    if (in_array($duoi, array('jpg', 'jpeg', 'png', 'gif','webp')) == true) {
        ...
        mysqli_query($conn, "INSERT INTO thongbao_shop(shop,tieu_de,minh_hoa,img_pop,noi_dung,nhan,doc,pop,poped,date_post)VALUES('0','$tieu_de','$minh_hoa','$img_pop','$noidung','$member_id','','$pop','',".time().")");
    } else {
