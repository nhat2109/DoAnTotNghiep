...
if (!isset($_COOKIE['emin_id'])) {
    ...
    if(strlen($tieu_de)<2){
        ...
        mysqli_query($conn,"INSERT INTO seeding_shopee_ncc(tieu_de,loai,thoi_gian,gia,gia_cu,uu_dai,thu_tu)VALUES('$tieu_de','$loai','$thoi_gian','$gia','$gia_cu','$uu_dai','$thu_tu')");
        $ok=1;
