<?php 
	...
	$thaythe['title']='Sửa gói dịch vụ seeding shopee';
	$thaythe['title_action']='Sửa gói dịch vụ seeding shopee';
	...
	if($r_tt['total']==0){
		...
		$replace=array(
			...
			'description'=>$index_setting['description'],
			'thongbao'=>$thongbao,
			'link_chuyen'=>'/admincp/list-seeding-shopee'
		);
		echo $skin->skin_replace('skin_cpanel/chuyenhuong',$replace);
		exit();
	}
	...
	$thaythe['box_right']=$skin->skin_replace('skin_cpanel/box_action/edit_seeding_shopee',$r_tt);  
?>