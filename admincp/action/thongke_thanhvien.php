...
$bien=array(
    ...
    'data_nam'=>$class_index->thongke_thanhvien_nam($conn,$ngay_dau,$ngay_cuoi),
    'list_ngay'=>$list_ngay,
    'data_thang'=>$class_index->thongke_thanhvien_thang($conn,$thangnay,$namnay,$ngay_dau_thang,$ngay_cuoi_thang),
    'data_tuan'=>$class_index->thongke_thanhvien_tuan($conn,$ngay_dau_tuan,$ngay_cuoi_tuan)
);
