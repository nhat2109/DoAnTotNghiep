<?php 
	...
	$thongtin=mysqli_query($conn,"SELECT *, count(*) AS total FROM mua_seeding_shopee WHERE id='$id'");
	...
	$thaythe['box_right']=$skin->skin_replace('skin_cpanel/box_action/edit_mua_seeding',$r_tt);  
?>