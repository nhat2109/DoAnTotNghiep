...
$thaythe['title']='Chỉnh sửa idol';
$thaythe['title_action']='Chỉnh sửa idol';
...
if($r_tt['total']==0){
    ...
    $replace=array(
        'title'=>'Idol không tồn tại...',
        'description'=>$index_setting['description'],
        'thongbao'=>$thongbao,
        'link_chuyen'=>'/admincp/list-idol'
    );
    echo $skin->skin_replace('skin_cpanel/chuyenhuong',$replace);
    exit();
}
$thaythe['box_right']=$skin->skin_replace('skin_cpanel/box_action/edit_idol',$r_tt);  
?>