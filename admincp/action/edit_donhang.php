...
foreach ($tach_sanpham as $key => $value) {
    ...
    $list_sanpham.=$skin->skin_replace('skin_cpanel/box_action/li_sanpham_order',$value);
}
...
$thaythe['box_right']=$skin->skin_replace('skin_cpanel/box_action/edit_donhang',$r_tt);
?>