<?php 
	...
	$thaythe['title']='Danh sách gói seeding shopee NCC';
	$thaythe['title_action']='Danh sách gói seeding shopee NCC';
	$limit=100;
	$thongke=mysqli_query($conn,"SELECT count(*) AS total FROM seeding_shopee_ncc");
	$r_tk=mysqli_fetch_assoc($thongke);
	$total_page=ceil($r_tk['total']/$limit);
	$bien=array(
		'list_goi'=>$class_index->list_goi_seeding_ncc($conn,$page,$limit),
