...
$thaythe['title']='Sửa giao diện';
$thaythe['title_action']='Sửa giao diện';
...
if($r_tt['total']==0){
    ...
    $replace=array(
        'title'=>'Giao diện không tồn tại...',
        'description'=>$index_setting['description'],
        'thongbao'=>$thongbao,
        'link_chuyen'=>'/admincp/list-giaodien'
    );
    echo $skin->skin_replace('skin_cpanel/chuyenhuong',$replace);
    exit();
}
...
$thaythe['box_right']=$skin->skin_replace('skin_cpanel/box_action/edit_giaodien',$r_tt);
?>