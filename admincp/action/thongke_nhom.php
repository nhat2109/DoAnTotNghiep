<?php 
	...
	$thaythe['title']='Thống kê đơn hàng của '.$r_tt['tieu_de'];
	$thaythe['title_action']='Thống kê đơn hàng của '.$r_tt['tieu_de'];
	$limit=10;
	$homnay=date('d');
	...
	$bien=array(
		...
		'data_nam'=>$class_index->thongke_donhang_nhom_nam($conn,$r_tt['thanhvien'],$ngay_dau,$ngay_cuoi),
		'list_ngay'=>$list_ngay,
		'data_thang'=>$class_index->thongke_donhang_nhom_thang($conn,$r_tt['thanhvien'],$thangnay,$namnay,$ngay_dau_thang,$ngay_cuoi_thang),
		'data_tuan'=>$class_index->thongke_donhang_nhom_tuan($conn,$r_tt['thanhvien'],$ngay_dau_tuan,$ngay_cuoi_tuan)
	);
	$thaythe['box_right']=$skin->skin_replace('skin_cpanel/box_action/thongke_nhom',$bien);
?>