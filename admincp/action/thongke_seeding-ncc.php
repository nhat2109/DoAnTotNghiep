<?php 
	...
	$thaythe['title']='Báo cáo doanh thu seeding shopee của NCC';
	$thaythe['title_action']='Báo cáo doanh thu seeding shopee của NCC';
	$end=date('d/m/Y');
	$date_end=date('d');
	$month_end=date('m');
	$year_end=date('Y');
	...
	$thaythe['box_right']=$skin->skin_replace('skin_cpanel/box_action/thongke_seeding_ncc',$bien);
?>