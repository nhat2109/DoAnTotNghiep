...
foreach ($tach_sanpham as $key => $value) {
    ...
    $list_sanpham.=$skin->skin_replace('skin_cpanel/box_action/li_sanpham_order_ctv',$value);
}
...
$r_tt['phi_ship']=number_format($r_tt['phi_ship']);
if($r_tt['chiu_ship']=='shop'){
    $r_tt['chiu_ship']='Shop trả';
}else{
    $r_tt['chiu_ship']='Khách trả';
}
...
$thaythe['box_right']=$skin->skin_replace('skin_cpanel/box_action/edit_donhang_ctv',$r_tt);
?>