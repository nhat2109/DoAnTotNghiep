<?php
			...
			if ($cat_tieude == '') {
				...
				if ($r_seo['total'] > 0) {
					...
					mysqli_query($conn, "INSERT INTO category_shop(shop,cat_tieude,cat_blank,cat_title,cat_main,cat_description,cat_index,cat_thutu)VALUES('$user_id','$cat_tieude','$cat_blank','$cat_title','$cat_main','$cat_description','$cat_index','$cat_thutu')");
