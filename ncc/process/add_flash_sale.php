<?php
	...
	if ($tieu_de == '') {
		...
		mysqli_query($conn, "INSERT INTO deal(shop,tieu_de,main_product,sub_product,sub_id,date_start,date_end,loai,date_post)VALUES('$user_id','$tieu_de','$sub_product','$list_product_sub','','$start','$end','flash_sale'," . time() . ")");
	}
	$info = array(
		'ok' => $ok,
		'thongbao' => $thongbao,
