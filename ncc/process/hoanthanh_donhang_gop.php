					...
					while ($r_cart_don = mysqli_fetch_assoc($thongtin_cart_don)) {
						...
						for ($i=0; $i < $so_luong[$id_sp]; $i++) {
							...
							if($user_info['leader']==1 OR $user_info['gia_leader']==1){
								...
								$r_cart_don['gia_ncc'] = number_format($product_pl[$id_sp]['gia_drop']);
								$r_cart_don['gia_moi_don'] = number_format(str_replace(',', '', $product_pl[$id_sp]['gia_moi']));
								$r_cart_don['quantity'] = 1;
								if ($k == 1) {
									$list .= '"' . $id_sp . '_'.$i.'":{"tieu_de":"' . addslashes($r_cart_don['tieu_de']) . '","soluong":"1","color":"' . $product_pl[$id_sp]['ten_color'] . '","ma_sanpham":"' . $product_pl[$id_sp]['ma_sp'] . '","size":"' . $product_pl[$id_sp]['ten_size'] . '","gia_moi":"' . $product_pl[$id_sp]['gia_moi'] . '","can_nang":"'.str_replace(',', '.', $product_pl[$id_sp]['can_nang']).'","gia_ncc":"' . $r_cart_don['gia_ncc'] . '","minh_hoa":"' . $r_cart_don['minh_hoa'] . '","giam":"' . $r_cart_don['giam'] . '","thanhtien":"' . $r_cart_don['thanhtien_gop'] . '"}';
									
								} else {
									$list .= ',"' . $id_sp . '_'.$i.'":{"tieu_de":"' . addslashes($r_cart_don['tieu_de']) . '","soluong":"1","color":"' . $product_pl[$id_sp]['ten_color'] . '","ma_sanpham":"' . $product_pl[$id_sp]['ma_sp'] . '","size":"' . $product_pl[$id_sp]['ten_size'] . '","gia_moi":"' . $r_cart_don['gia_moi_don'] . '","can_nang":"'.str_replace(',', '.', $product_pl[$id_sp]['can_nang']).'","gia_ncc":"' . $r_cart_don['gia_ncc'] . '","minh_hoa":"' . $r_cart_don['minh_hoa'] . '","giam":"' . $r_cart_don['giam'] . '","thanhtien":"' . $r_cart_don['thanhtien_gop'] . '"}';
								}
							}else{
								$tamtinh += $product_pl[$id_sp]['gia_ncc'];
								$thanhtien=$product_pl[$id_sp]['gia_ncc'];
								$tong_giam+=($thanhtien/100)*$giam_sp;
								$r_cart_don['giam'] = number_format(($thanhtien/100)*$giam_sp);
								$thanhtien_gop += $thanhtien - ($thanhtien/100)*$giam_sp;
								$r_cart_don['thanhtien_gop'] = number_format($thanhtien - ($thanhtien/100)*$giam_sp);
								$r_cart_don['gia_ncc_moi'] = number_format($product_pl[$id_sp]['gia_ncc']);

								$r_cart_don['gia_moi_don'] = number_format(str_replace(',', '', $product_pl[$id_sp]['gia_moi']));
								$r_cart_don['quantity'] = 1;
								if ($k == 1) {
									$list .= '"' . $id_sp . '_'.$i.'":{"tieu_de":"' . addslashes($r_cart_don['tieu_de']) . '","soluong":"1","color":"' . $product_pl[$id_sp]['ten_color'] . '","ma_sanpham":"' . $product_pl[$id_sp]['ma_sp'] . '","size":"' . $product_pl[$id_sp]['ten_size']. '","gia_moi":"' . $r_cart_don['gia_moi'] . '","can_nang":"'.str_replace(',', '.', $product_pl[$id_sp]['can_nang']).'","gia_ncc":"' . $r_cart_don['gia_ncc_moi'] . '","minh_hoa":"' . $r_cart_don['minh_hoa'] . '","giam":"' . $r_cart_don['giam'] . '","thanhtien":"' . $r_cart_don['thanhtien_gop'] . '"}';
									
								} else {
									$list .= ',"' . $id_sp . '_'.$i.'":{"tieu_de":"' . addslashes($r_cart_don['tieu_de']) . '","soluong":"1","color":"' . $product_pl[$id_sp]['ten_color'] . '","ma_sanpham":"' . $product_pl[$id_sp]['ma_sp'] . '","size":"' . $_SESSION['drop_cart'][$id_sp]['size'] . '","gia_moi":"' . $r_cart_don['gia_moi_don'] . '","can_nang":"'.str_replace(',', '.', $r_cart_don['can_nang']).'","gia_ncc":"' . $r_cart_don['gia_ncc_moi'] . '","minh_hoa":"' . $r_cart_don['minh_hoa'] . '","giam":"' . $r_cart_don['giam'] . '","thanhtien":"' . $r_cart_don['thanhtien_gop'] . '"}';
								}
							}
						}
