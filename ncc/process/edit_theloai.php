<?php
			...
			if ($cat_tieude == '') {
				...
				if ($cat_blank == $link_old) {
					...
					mysqli_query($conn, "UPDATE category_shop SET cat_tieude='$cat_tieude',cat_main='$cat_main',cat_blank='$cat_blank',cat_title='$cat_title',cat_description='$cat_description',cat_thutu='$cat_thutu',cat_index='$cat_index' WHERE cat_id='$cat_id' AND shop='$user_id'");
					...
					if ($r_seo['total'] > 0) {
						...
						$ok = 1;
						$thongbao = "Sửa danh mục thành công";
						mysqli_query($conn, "UPDATE category_shop SET cat_tieude='$cat_tieude',cat_blank='$cat_blank',cat_main='$cat_main',cat_title='$cat_title',cat_description='$cat_description',cat_thutu='$cat_thutu' WHERE cat_id='$cat_id' AND shop='$user_id'");
