<?php
	...
	if ($step == 2) {
		...
		if ($r_check['total'] == 0) {
			...
			$thaythe['box_right'] = $skin->skin_replace('skin_ncc/box_action/add_sanpham_step2', $r_tt);
		} else {
		...
		//$r_tt['phantrang'] = $class_index->phantrang($page, $total_page, '/ncc/add-sanpham');
		...
		if($check->is_mobile()==true){
			...
			$thaythe['box_right'] = $skin->skin_replace('skin_ncc/box_action/add_sanpham_step1_mobile', $r_tt);
		}else{
			...
			$thaythe['box_right'] = $skin->skin_replace('skin_ncc/box_action/add_sanpham_step1', $r_tt);
		}
	}
?>