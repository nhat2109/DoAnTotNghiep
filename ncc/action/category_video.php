<?php
	...
	$bien = array(
		...
		'phantrang' => $class_index->phantrang($page, $total_page, '/ncc/danh-muc-video/'.$link),
	);
	$thaythe['box_right'] = $skin->skin_replace('skin_ncc/box_action/list_video_category', $bien);
?>