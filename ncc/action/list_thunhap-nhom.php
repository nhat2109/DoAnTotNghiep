<?php
	...
	if($list_id==''){
		...
		$bien = array(
			...
			'loai'=>$loai,
			'phantrang' => $class_index->phantrang_timkiem($page, $total_page, '/ncc/list-thunhap-nhom?loai='.$loai),
		);
	}
	$thaythe['box_right'] = $skin->skin_replace('skin_ncc/box_action/list_thunhap_nhom', $bien);
?>