<?php
	...
	$bien = array(
		...
		'phantrang' => $class_index->phantrang($page, $total_page, '/ncc/list-thanhvien-nhom'),
		// thongke_donhang-nhom
		'tuan' => $week,
		'thang' => date('m'),
		'nam' => date('Y'),
		...
		$thaythe['box_right'] = $skin->skin_replace('skin_ncc/box_action/list_thanhvien_nhom', $bien);
	}	
?>