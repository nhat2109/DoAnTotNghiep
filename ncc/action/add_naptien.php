<?php
	...
	if ($step == 2) {
		if (isset($_SESSION['naptien'])) {
			...
			$thaythe['box_right'] = $skin->skin_replace('skin_ncc/box_action/add_naptien_step2', $r_tt);
		} else {
		...
		$thaythe['box_right'] = $skin->skin_replace('skin_ncc/box_action/add_naptien_step1', $r_tt);
	}
?>