...
//7-4
        ...
        if ($total_banner == 0) {
            ...
            $replace = array(
                ...
                'thongbao' => $thongbao,
                'link_chuyen' => '/ncc/list-banner',
            );
            echo $skin->skin_replace('skin_nc/chuyenhuong', $replace);
            exit();
        }
        $r_banner = mysqli_fetch_assoc($thongtin_banner);
        $thaythe['box_right']= $skin->skin_replace('skin_ncc/box_action/edit_banner', $r_banner); 