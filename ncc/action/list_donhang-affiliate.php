<?php
	...
	$bien = array(
		...
		'phantrang' => $class_index->phantrang($page, $total_page, '/ncc/list-donhang-affiliate'),
	);
	$thaythe['box_right'] = $skin->skin_replace('skin_ncc/box_action/list_donhang_affiliate', $bien);
?>