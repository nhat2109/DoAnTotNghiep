<?php
	...
	$bien = array(
		...
		'phantrang' => $class_index->phantrang($page, $total_page, '/ncc/list-sanpham-hethang'),
	);
	$thaythe['box_right'] = $skin->skin_replace('skin_ncc/box_action/list_sanpham_hethang', $bien);
?>