...
<header>
	...
	<div class="top-header">
		<div class="container">
			<div class="topbar">
				<div class="kenh_ban">
					<a href="/dangky-ncc.html" class="text_pc"><i class="fa fa-angle-double-right"
							aria-hidden="true"></i> Kênh nhà cung cấp</a>
					<span class="text_phan_cach">|</span>
					<a href="/dangky-banhang.html" class="text_pc"><i class="fa fa-angle-double-right"
							aria-hidden="true"></i> Kênh dropship</a>
					<a href="/dangky-ncc.html" class="text_mobile"><i class="fa fa-angle-double-right"
							aria-hidden="true"></i>Nhà cung cấp</a>
					<a href="/dangky-banhang.html" class="text_mobile"><i class="fa fa-angle-double-right"
							aria-hidden="true"></i> Dropship</a>
				</div>
				<div class="text_top">
					<!-- <?php echo $index_setting['title_link_top'];?>
					<a href="<?php echo $index_setting['link_top'];?>">Đến ngay <i
						class="fa fa-long-arrow-right"></i></a> -->
					<a href="/setup-domain.php" class="text_pc"><i class="fa fa-server" aria-hidden="true"></i> Quản lý
						công việc</a>
					<a href="/setup-domain.php" class="text_mobile"><i class="fa fa-server" aria-hidden="true"></i> Quản
						lý công việc</a>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="box_control">
				<div class="user_control">
					<div class="user_control_action">
						<button class="show_login" title="Đăng nhập"><i class="fa fa-user" aria-hidden="true"></i> Đăng
							nhập</button>
						<div class="user_control_action_register">
							<button class="show_register" title="Đăng ký"><i class="fa fa-user-plus"
									aria-hidden="true"></i> Đăng ký</button>
							<div class="user_control_action_register_content">
								<a href="/dang-ky.html">
									<div class="user_control_action_register_content_item"><i class="fa fa-user"
											aria-hidden="true"></i> Tài khoản mua hàng</div>
									<div class="user_control_action_register_content_item_text">Đăng ký tài khoản dành
										cho người mua hàng</div>
								</a>
								<a href="/dangky-ncc.html">
									<div class="user_control_action_register_content_item"><i class="fa fa-building"
											aria-hidden="true"></i> Nhà cung cấp</div>
									<div class="user_control_action_register_content_item_text">Đăng ký tài khoản dành
										cho nhà cung cấp</div>
								</a>
								<a href="/dangky-banhang.html">
									<div class="user_control_action_register_content_item"><i class="fa fa-shopping-bag"
											aria-hidden="true"></i> Tài khoản dropship</div>
									<div class="user_control_action_register_content_item_text">Đăng ký tài khoản để trở
										thành dropship</div>
								</a>
							</div>
						</div>
...
<script>
	...
	$(document).ready(function () {
		...
		$(document).on("click", "#closeOutputSearchMobile", function (e) {
			e.preventDefault();
			$("#output_search_mobile").hide();
		});
