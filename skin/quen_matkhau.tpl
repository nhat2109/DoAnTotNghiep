...
<body>
	        ...
	        <div class="row">
	            <div class="col-12 a-left">
	                <ul class="breadcrumb m-0 px-0" itemscope="" itemtype="http://schema.org/BreadcrumbList">
	                    ...
	                    <li class="active"><span>Lấy lại mật khẩu</span></li>
	                </ul>
	            </div>
	        </div>
	    </div>
	...
	<div class="home_box" style="margin-top: 20px;">
		<div class="container">
			<div class="title_box">
				<h2><a href="/quen-mat-khau.html" class="link">Lấy lại mật khẩu</a></h2>
			</div>
			<div class="tab_box">
				<div class="tab" style="padding-bottom: 10px;">
					<div class="box_login" style="width: 450px;">
						...
						<div class="li_input">
							...
							<input type="password" name="re_password" placeholder="Nhập lại mật khẩu mới">
						</div>
						<div class="li_input">
							...
							<div class="list_col">
								...
								<div class="col right" style="width: 45%;">
									<button id="get_opt_password" style="width: 160px;">Lấy mã xác nhận</button>
								</div>
							</div>
						</div>
						<div class="li_input">
							<button type="button" class="button_login" name="quen_matkhau">Lưu mật khẩu</button>
						</div>
						<div class="li_input">
							<div class="text-center">
								<a href="/dang-ky.html">Đăng ký</a> | <a href="/dang-nhap.html">Đăng nhập</a>
							</div>
						</div>
                        <div class="li_input">
                            <div class="text"><b>Lưu ý 111:</b><br> + Mã xác nhận sẽ được gửi tới số điện thoại đăng ký tài khoản.<br>+ Sau khi yêu cầu lấy mã xác nhận vui lòng đợi ít phút để nhận mã.<br> 
