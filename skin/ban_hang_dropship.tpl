			...
			<div class="container_member">
				...
				<div class="box_right">
					<div class="list_action">
						<div class="action">
							<a href="/ban-hang.html" class="active">
...
<!-- 						<div class="action">
					...
					<div class="list_box_tab_banhang">
						<div class="list_tab">
							<div class="tab active" id="tab_reg_drop">Đăng ký nhà bán hàng</div>
							<!-- <div class="tab" id="tab_reg_ctv">Đăng ký cộng tác viên</div> -->
						</div>
						<div class="content_tab active" id="content_tab_drop">
