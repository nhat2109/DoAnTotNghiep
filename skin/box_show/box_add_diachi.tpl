<div class="box_show_update_content" style="width: 650px;">
    <div class="content">
        <div class="box_title">Thêm địa chỉ <span><i class="fa fa-close"></i></span></div>
        <div class="form_update">
            <div class="li_input">
                <label>Họ và tên</label>
                <input type="text" name="ho_ten" value="" placeholder="Họ và tên">
            </div>
            <div class="li_group_input col_2">
                <div class="li_input">
                    <label>Điện thoại</label>
                    <input type="text" name="dien_thoai" value="" placeholder="Điện thoại">
                </div>
                <div class="li_input">
                    <label>Email</label>
            ...
            <div class="li_input">
                <button type="button" class="button_login" name="add_diachi">Hoàn thành</button>
            </div>
        </div>
    </div>
</div>
