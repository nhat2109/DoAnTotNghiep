...
<body>
    ...
    <div class="main_tintuc">
        <!-- Thêm phần thông tin shop -->
        <div class="box-content mb-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-auto" style="margin: 30px;">
                        <img src="{shop_avatar}" alt="{shop_name}" class="shop-avatar">
                    </div>
                    <div class="col d-flex align-items-center flex-wrap">
                        <span class="shop-name mr-3">{shop_name}</span>
                        <div class="shop-stats d-flex align-items-center flex-wrap">
                            <div class="stat-item mr-3">
                                <span class="stat-label">Sản Phẩm:</span>
                                <span class="stat-value">{shop_product_count}</span>
                            </div>
                            <div class="stat-item mr-3">
                                <span class="stat-label">Người Theo Dõi:</span>
                                <span class="stat-value">{shop_followers}</span>
                            </div>
                            <div class="stat-item mr-3">
                                <span class="stat-label">Tỉ Lệ Phản Hồi Chat:</span>
                                <span class="stat-value">{shop_chat_response_rate}%</span>
                            </div>
                            <div class="stat-item mr-3">
                                <span class="stat-label">Tham Gia:</span>
                                <span class="stat-value">{shop_join_duration}</span>
                            </div>
                            <div class="shop-actions">
                                <button class="btn btn-primary mr-2">
                                    <i class="fas fa-plus mr-1"></i> Theo Dõi
                                </button>
                                <a href="https://zalo.me/{shop_mobile}" class="btn btn-outline-primary mr-2" target="_blank">
                                    <i class="fab fa-whatsapp mr-1"></i> Chat
                                </a>
                                <a href="tel:{shop_mobile}" class="btn btn-outline-primary">
                                    <i class="fas fa-mobile mr-1"></i> Gọi
...
<style>
        ...
        .shop-info {
            background: #fff;
            padding: 15px 0;
            border-bottom: 1px solid #eee; /* Thêm đường viền dưới nhẹ để phân cách */
        }
        ...
        .shop-name {
            ...
            font-weight: 600;
            color: #333;
            margin-right: 15px; /* Khoảng cách với các thông tin khác */
        }
        ...
        .stat-item {
            ...
            align-items: center;
            margin-right: 15px;
            margin-bottom: 5px; /* Khoảng cách dưới trên mobile */
        }
        ...
        .stat-value {
            color: #ff5722; /* Màu cam đậm hơn một chút */
            font-weight: 500;
        }
        ...
        .shop-actions {
            display: flex;
            align-items: center;
            margin-left: 10px; /* Khoảng cách với các thông tin */
        }
        ...
        .shop-actions a.btn-primary {
            background-color: #ff5722;
            border-color: #ff5722;
            color: #fff;
            box-shadow: 0 2px 5px rgba(255, 87, 34, 0.2); /* Thêm bóng nhẹ */
        }
        
        .shop-actions .btn-primary:hover,
        .shop-actions a.btn-primary:hover {
            background-color: #e64a19;
            border-color: #e64a19;
            box-shadow: 0 3px 8px rgba(255, 87, 34, 0.3); /* Bóng đậm hơn khi hover */
        }
        
        .shop-actions .btn-outline-primary,
        .shop-actions a.btn-outline-primary {
            color: #ff5722;
            border-color: #ff5722;
        ...
        .shop-actions .btn-outline-primary:hover,
        .shop-actions a.btn-outline-primary:hover {
            background-color: #ff5722;
            color: #fff;
