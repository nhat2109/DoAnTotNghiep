		...
		<div class="container">
			<div class="box_logo">
				...
				<div class="form_search">
					<!-- Chức năng tìm kiếm nâng cao -->
					<div class="input_search">
						<input type="text" id="key" placeholder="Tìm kiếm sản phẩm" autocomplete="off">
						<button type="button"><i class="fa fa-search"></i></button>
			...
			<div class="box_control">
				<div class="user_control">
					<div class="user_control_item">
						<a href="/tai-khoan.html">
							<img src="/skin/css/images/icon-header/icon_user_not_login.svg" alt="icon user">
							<span>Chào! {name}</span>
						</a>
					</div>
					<div class="dropdown-content">
						<a href="/tai-khoan.html"><i class="fa fa-user" aria-hidden="true"></i>Thông tin tài khoản</a>
						<a href="/don-hang.html"><i class="fa fa-clock-o" aria-hidden="true"></i> Lịch sử đặt hàng</a>
						<a href="/vi-voucher.html"><i class="fa fa-ticket" aria-hidden="true"></i> Lấy mã khuyến mãi</a>
						<a href="/dang-xuat.html"><i class="fa fa-power-off" aria-hidden="true"></i> Đăng xuất</a>
					</div>
				</div>
