...
<header>
	...
	<div class="top-header">
		<div class="container">
			<div class="topbar">
				<div class="kenh_ban">
					<a href="/dangky-ncc.html"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Kênh nhà cung cấp</a>
					<a href="/dangky-banhang.html"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Kênh dropship</a>
				</div>
				<div class="text_top">
	...
	<div class="main-header">
		<div class="container">
			...
			<div class="box_control">
				<a style="margin-right: 20px;" href="/tai-khoan.html"><img
						src="/skin/css/images/icon-header/icon_user_login.svg" alt="icon user"></a>
