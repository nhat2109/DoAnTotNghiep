...
<body style="">
                                    ...
                                    <tbody>
                                        <tr class="total-line total-line-subtotal">
                                            ...
                                            <td class="total-line-price">
                                                <span class="order-summary-emphasis" data-checkout-subtotal-price-target="548000000">
                                                    {tamtinh}₫
                                                </span>
                                            </td>
                                        </tr>
            ...
            <div class="main">
                <div class="main-header">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item ">
                            <a href="/checkout.html?step=1" class="breadcrumb-link">
                                Thông tin giao hàng
                            </a>
                        </li>
                    ...
                    <div class="step">
                                            ...
                                            <div class="radio-wrapper">
                                                <label class="radio-label">
                                                    <div class="radio-input">
                                                        <input class="input-radio" type="radio" name="vanchuyen" checked="">
                                                    </div>
                                ...
                                <div class="section-content">
                                    <div class="content-box">
                                        <div class="radio-wrapper content-box-row">
                                            <label class="radio-label">
                                                <div class="radio-input">
                                                    <input class="input-radio" name="payment_method_id" type="radio" value="cod" checked="">
                                                </div>
                                        ...
                                        <div class="radio-wrapper content-box-row">
                                            <label class="radio-label">
                                                <div class="radio-input">
                                                    <input class="input-radio" name="payment_method_id" type="radio" value="chuyenkhoan">
                                                </div>
                                        ...
                                        <div class="radio-wrapper content-box-row">
                                            <label class="radio-label">
                                                <div class="radio-input">
                                                    <input class="input-radio" name="payment_method_id" type="radio" value="diem">
                                                </div>
                                                <span class="radio-label-primary">Điểm thưởng (Dùng điểm thưởng của bạn để thanh toán đơn hàng)</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="step-footer">
                            <form id="form_next_step" accept-charset="UTF-8" method="post">
                                <button type="button" id="checkout_step_2" class="step-footer-continue-btn btn">
                                    <span class="btn-content">Hoàn tất đơn hàng</span>
                                    <i class="btn-spinner icon icon-button-spinner"></i>
                                </button>
                            </form>
                            <a href="/checkout.html?step=1" class="step-footer-previous-link">
    ...
    $("input[name=payment_method_id][value=" + thanhtoan + "]").prop('checked', true);
    </script>
    <style type="text/css">
    .load_overlay {
        position: fixed;
