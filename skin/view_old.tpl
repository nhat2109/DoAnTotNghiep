        ...
        <div class="container">
            <div class="row">
                ...
                <div class="product_info">
                    <h1 class="product_title">{tieu_de}</h1>
                    <div class="row">
                        <div class="left_info">
                            ...
                            <div class="price-box">
                                <span class="special-price"><span class="price product-price">{gia_moi}₫</span>
                                </span> <!-- Giá Khuyến mại -->
                                    ...
                                    <div class="form_product_content type1 ">
                                        ...
                                        <div class="soluong soluong_type_1 show">
                                            ...
                                            <div class="custom-btn-number">
                                                ...
                                                <input type="text" name="quantity" id="quantity_view" value="1" maxlength="3">
                        ...
                        <div class="right_info">
                            ...
                            <div class="product-policises-wrapper" style="margin-top: 10px;">
                                ...
                                <ul class="product-policises">
                                    <li class="media">
                                        <div class="mr-3">
                                            <img class="img-fluid lazyload loaded" src="//theme.hstatic.net/1000410088/1000745150/14/policy_product_image_1.png?v=128" data-src="//theme.hstatic.net/1000410088/1000745150/14/policy_product_image_1.png?v=128" alt="Miễn phí vận chuyển" data-was-processed="true">
                                        </div>
