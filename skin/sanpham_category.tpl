...
<style>
	/* huyphuc07/05/2025 */
	.li_product {
    position: relative; /* Tạo context cho position: absolute */
    border: 1px solid #0000001c; /* Giữ nguyên style hiện tại */
    min-height: 300px; /* Đảm bảo chiều cao đủ để chứa .location */
}

.location {
    position: absolute;
    bottom: 0px; /* Khoảng cách từ đáy */
    left: 18px; /* Khoảng cách từ trái */
    display: flex; /* Giữ layout hiện tại */
