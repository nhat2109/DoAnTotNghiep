<div class="item-popup">
    <div style="width: 55%;" class="text-left">
        ...
        <div class="item-info">
            ...
            <p class="item-remove"><a href="javascript:;" class="remove-cart-popup" title="Xóa" data-id="{id}"><i style="color: red;" class="fa fa-close"></i> Bỏ sản phẩm</a></p>
    ...
    <div style="width: 15%;" class="text-center">
        ...
        <input type="text" style="border: none;" maxlength="12" min="0" class="input-text number-sidebar" name="quantity" size="4" value="{quantity}">
