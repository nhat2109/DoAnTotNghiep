...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://fonts.googleapis.com/css?family=Roboto:100:300,400,500,700,900|Material+Icons|Open Sans:bold,regular|Tinos:bold,regular|Cormorant Upright:bold,regular|Roboto:bold,regular|Baloo Bhaina:bold,regular|Lobster:bold,regular&display=swap"
        as="style">
    <meta name="description" content="Socdo.vn - Thanh toán đơn hàng">
    <style>
        .btn {
        ...
        .box_gopdon .chinh_sach {
            margin-top: 10px;
        }

        .box_gopdon .chinh_sach ul {
            margin-top: 10px;
            margin-bottom: 10px;
            list-style: square;
            margin-left: 20px;
        ...
        /* Khi input được chọn */
        .li_phuongthuc input:checked+label {
            background: #f8f8f8;
            border-radius: 6px;
        }

        /* Định dạng lại radio button */
        .li_phuongthuc input[type="radio"] {
            appearance: none;
            width: 16px;
            height: 16px;
        ...
        .li_phuongthuc input[type="radio"]:checked {
            border-color: #007bff;
        }

        .li_phuongthuc input[type="radio"]:checked::before {
            content: "";
            width: 8px;
            height: 8px;
            background: #007bff;
                                            ...
                                            <div class="field-input-btn-wrapper">
                                                <div class="field-input-wrapper">
                                                    ...
                                                    <input placeholder="Mã giảm giá" class="field-input" size="30"
                                                        type="text" name="coupon_mobile" value="{coupon}">
                                                </div>
                                                <button type="button" id="button_coupon_mobile"
                                        ...
                                        <div class="field  ">
                                            <div class="field-input-btn-wrapper">
                                                <div class="field-input-wrapper">
                                                    <label class="field-label" for="discount.code">Mã giảm giá</label>
                                                    <input placeholder="Mã giảm giá" class="field-input" size="30"
                                                        type="text" name="coupon_desktop" value="{coupon}">
                                                </div>
                                                <button type="button" id="button_coupon_desktop"
                                                    class="field-input-btn btn btn-default">
                                                    <span class="btn-content">Sử dụng</span>
                                                    <i class="btn-spinner icon icon-button-spinner"></i>
                                                </button>
                                ...
                                <div class="box_phuongthuc">
                                    ...
                                    <div class="list_phuongthuc">
                                        <div class="li_phuongthuc">
                                            <input type="radio" name="phuongthuc" checked="checked" value="cod"
                                                id="cod">
                                            <label for="cod">
                                        ...
                                        <div class="li_phuongthuc">
                                            ...
                                            <label for="qr">
                                                ...
                                                <div class="text">Quét QR và thanh toán bằng ứng dụng ngân hàng<br>Mở
                                                    ứng dụng ngân
            ...
            <div class="main">
                ...
                <div class="main-content">
                    <div class="step">
                        <div class="step-sections " step="1">
                            <div class="section">
                                ...
                                <div class="section-content">
                                    <div class="fieldset">
                                        <form id="form_update_shipping_method" class="field default"
                                            ...
                                            <div class="content-box mt0">
                                                <div id="form_update_location_customer_shipping"
                                                    ...
                                                    <div class="field field-full field-show-floating-label">
                                                        <div class="field-input-wrapper">
                        ...
                        <!-- <div class="list_note_gop" style="margin-top: 20px;width: 100%;">
                            <div class="note_gop">Bạn hãy cố gắng mua thêm sản phẩm để tạo đơn: <b
                                    class="color_red">SIÊU GỘP ĐƠN</b>, nhận thêm nhiều ưu đãi cực lớn!</div>
                            <div class="box_gopdon">
                                <div class="box_gopdon_content">
                                    ...
                                    <div class="chinh_sach">
                                        Ngoài việc giúp Khách hàng được <b>mua LẺ với giá SỈ</b>. Sóc Đỏ tiếp tục ra mắt
                                        chương trình <b>SIÊU GỘP ĐƠN</b> cực hời tới toàn bộ cộng đồng nhà bán. Giảm giá
                                        bán trực tiếp cho <b>đơn hàng có từ 2 sản phẩm bất kỳ trở lên</b>, cụ thể:<br>
                                        <ul>
                                        ...
                                        <i class="color_red bold">Lưu ý : Áp dụng cho một đơn hàng không quá 05 sản phẩm
                                            và có sự điều chỉnh tỷ lệ chiết khấu đối với Nhà Bán hàng chuyên
                                            nghiệp.</i><br>
