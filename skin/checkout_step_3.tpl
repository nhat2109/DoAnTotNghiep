...
<head>
    ...
    <meta name="description" content="Socdo.vn - Đơn hàng#{ma_don}">
                    ...
                    <div class="order-summary order-summary-is-collapsed">
                        ...
                        <div class="order-summary-sections">
                            ...
                            <div class="order-summary-section order-summary-section-total-lines payment-lines" data-order-summary-section="payment-lines">
                                ...
                                <div class="note_payment"><span>Lưu ý:</span> Tổng tiền trên chưa bao gồm phí vận chuyển</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        <div class="section">
                            <div class="section-header os-header">
                                ...
                                <div class="os-header-heading">
                                    ...
                                    <span class="os-description" style="color: red">
                                        Nhân viên SÓC ĐỎ sẽ liên hệ lại để xác nhận đơn hàng!
                                    </span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="content-box-row content-box-row-padding">
                                        <div class="section-content">
                                            <div class="section-content-column">
                                                <h3 style="font-weight: 700;">Thông tin giao hàng</h3>
                                                Họ và tên: {ho_ten}
                                                <br>
                                                ...
                                                <h3 style="font-weight: 700;">Phương thức thanh toán</h3>
                                                <p>
                                                    {phuongthuc}
                                                </p>
                                                <p style="margin-top: 20px;">{nganhang}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="step-footer">
                            ...
                            <p class="step-footer-info">
                                ...
                                <span>
                                    Cần hỗ trợ? <a href="/lien-he.html">Liên hệ chúng tôi</a>
                                </span>
                            </p>
                        </div>
                    </div>
