...
<div class="home_deal goi_y_sp">
    <div class="container">
        <div class="heading-bar goiy_heading" style="background-color: #fff;color: #000; border-bottom: 1px solid #0000001c; border-radius: 5px 5px 0px 0px;">
            <div class="top_hotdeal">
                <div class="goiy__countdown-wrapper">
                    <span class="goiy__countdown-label" style="font-size: 18px; font-weight: bold; color: #000; text-align: left;"><i class="fa fa-shopping-cart" style="font-size: 18px; color: #d41e25"></i> GỢI Ý HÔM NAY</span>
                </div>
            </div>
        </div>
