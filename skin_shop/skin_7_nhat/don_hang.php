...
// echo $class_index->list_donhang($conn,$s,$shop,$user_id,$page,$limit);
// exit();
...
$replace = array(
	...
	'thang'=>date('m'),
	'nam'=>date('Y'),
	'list_donhang'=>$class_index->list_donhang($conn,$s,$shop,$user_id,$page,$limit),
	'shop'=>$r_shop['user_id'],
...
echo $skin->skin_replace('skin_shop/'.$s.'/tpl/don_hang',$replace);
?>