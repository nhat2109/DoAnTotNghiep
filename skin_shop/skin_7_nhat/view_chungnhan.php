...
$thongtin = mysqli_query($conn, "SELECT *,count(*) AS total FROM chung_nhan WHERE cat_link='$blank' AND shop='{$r_shop['user_id']}'");
...
mysqli_query($conn, "UPDATE chung_nhan SET view='$view_new' WHERE id='{$r_tt['id']}' AND shop='{$r_tt['shop']}'");
...
echo $skin->skin_replace('skin_shop/' . $s . '/tpl/view_chungnhan', $replace);
?>