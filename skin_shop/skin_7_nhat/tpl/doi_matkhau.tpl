    ...
    <div class="row">
        <div class="container_member">
            ...
            <div class="box_right">
                ...
                <div class="box_profile" style="width: 420px;">
                    <div class="li_input">
                        <div class="col_100">
...
<style>
    ...
    label {
        ...
        font-weight: bold;
        margin-bottom: 5px; /* Khoảng cách giữa nhãn và ô nhập */
        color: #333;
    }
    
    input[type="password"] {
        width: calc(100% - 20px); /* Chiếm toàn bộ chiều rộng trừ padding */
        padding: 10px; /* Khoảng cách nội dung trong ô nhập */
        border: 1px solid #ccc; /* Viền ô nhập */
        border-radius: 4px; /* Bo góc ô nhập */
        font-size: 14px; /* Cỡ chữ */
        box-sizing: border-box; /* Tính cả viền và padding vào kích thước */
        outline: none;
        transition: border 0.3s; /* Hiệu ứng khi hover/focus */
    }
    
    input[type="password"]:focus {
        border-color: #ec720e; /* Màu viền khi focus */
    }
    
    button[name="change_password"] {
        background-color: #ec720e; /* Màu nền */
        color: #fff; /* Màu chữ */
        border: none;
        border-radius: 4px;
        ...
        font-size: 14px; /* Cỡ chữ */
        font-weight: bold;
        cursor: pointer; /* Thêm biểu tượng chuột */
        transition: background-color 0.3s; /* Hiệu ứng màu */
    }
    
    button[name="change_password"]:hover {
        background-color: #ff7300; /* Màu khi hover */
    }
    
    button[name="change_password"]:active {
        background-color: #c06419; /* Màu khi nhấn */
    }
