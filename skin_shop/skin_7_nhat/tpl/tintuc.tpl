...
<head>
    ...
    <script type="application/ld+json">
      ...
      
      {
                ...
                "item": 
                {
                  "@id": "https://ega-furniture.mysapo.net/gioi-thieu",
                  "name": "Giới thiệu"
                }
            }
...
<body id="template-page">
    ...
    <link rel="preload" as='style' type="text/css"
        href="/skin_shop/skin_7_nhat/tpl/css/header.css">
    ...
    {box_header}
    <div class="container blog-section" itemscope="" itemtype="http://schema.org/Blog">
...
.right-content a:hover {
    color: #fb9b24; /* Màu cam khi hover */
}

/* Đổi màu nút "Đọc tiếp" */
.button_custome_35 {
    color: #fff; /* Màu chữ */
    background-color: #fb9b24; /* Màu nền mặc định */
    border: 1px solid #fb9b24;
    padding: 10px 15px;
...
.button_custome_35:hover {
    background-color: #FFA500; /* Màu nền cam khi hover */
    border-color: #FFA500;
...
.breadcrumb .home a span:hover {
    color: #ec720e; /* Màu chữ khi hover */
}
...
.li_tintuc {
    flex: 1 1 calc(33.333% - 20px); /* Desktop: 3 cột */
    background: #fff;
    border: 1px solid #eee;
    border-radius: 10px;
    overflow: hidden;
...
@media (max-width: 768px) {
    ...
    .info p {
        font-size: 13px; /* Giảm kích thước đoạn văn */
    }
...
@media (min-width: 769px) and (max-width: 1024px) {
    .li_tintuc {
        flex: 1 1 calc(50% - 20px); /* Tablet: 2 cột */
    }
}

   /* Tạo bố cục đẹp và nhất quán cho danh mục */
.blog-section .nav-category {
    padding: 0;
    list-style: none; /* Loại bỏ bullet */
}

.blog-section .nav-category .nav-item {
    border-bottom: 1px solid #ddd; /* Đường viền ngăn cách */
    padding: 15px; /* Khoảng cách bên trong mục */
...
.blog-section .nav-category .nav-item:last-child {
    border-bottom: none; /* Loại bỏ viền cuối */
}

.blog-section .nav-category .menu-item__link {
    color: #333; /* Màu chữ mặc định */
    text-decoration: none; /* Loại bỏ gạch chân */
    font-weight: bold; /* In đậm tiêu đề */
    display: block; /* Mỗi tiêu đề 1 dòng */
    font-size: 16px; /* Cỡ chữ */
    transition: all 0.3s ease; /* Hiệu ứng mượt */
}

.blog-section .nav-category .menu-item__link:hover {
    color: #fff; /* Màu chữ khi hover */
    background-color: #ec720e; /* Nền khi hover */
    padding-left: 20px; /* Tạo hiệu ứng đẩy chữ sang phải */
    border-radius: 5px; /* Bo góc */
}

    /* Bố cục chính cho phần Bài viết mới */
.aside-item .heading {
    margin-bottom: 15px;
    border-bottom: 2px solid #ec720e; /* Đường viền nhấn mạnh */
    padding-bottom: 5px;
}
...
.aside-item .blogs-rights .blog-item-name a {
    font-size: 16px;
    font-weight: bold;
    color: black;
    text-decoration: none;
...
.aside-item .blogs-rights .blog-item-name a:hover {
    color: #ec720e; /* Màu khi hover */
}

.aside-item .blogs-rights .post-time {
    font-size: 12px;
    color: #777;
}
...
<div class='menu-overlay'>
    ...
    <noscript>
        <link href="/skin_shop/skin_7_nhat/tpl/css/addthis-sharing.css"
            rel="stylesheet" type="text/css" media="all" />
    </noscript>
...
Vui lòng chọn mua thêm sản phẩm
    ...
    <script src="/skin_shop/skin_7_nhat/tpl/js/ega-gateway-min.js"
...
Vui lòng chọn mua thêm sản phẩm`
    ...
    <script src="/skin_shop/skin_7_nhat/tpl/js/api-jquery-custom.js"
        type="text/javascript"></script>
