...
<style>
	@media (max-width: 768px) {
		...
		.container_member {
			flex-direction: column; /* Chuyển sang cột dọc */
		  }
		  ...
		  .container_member .box-right .box_profile {
			width: 100%; /* Chiếm toàn bộ chiều ngang màn hình */
			padding: 10px; /* Thêm khoảng cách cho giao diện dễ nhìn */
			box-sizing: border-box; /* Đảm bảo padding không ảnh hưởng chiều rộng */
		  }
		  .li_input {
			display: flex;
			flex-direction: column; /* Xếp các input theo cột dọc */
		  ...
		  .li_input .col_30 label {
			display: block;
			margin-bottom: 5px; /* Tách nhãn khỏi input */
		  }
		
		  .li_input .col_30 input {
			width: 100%;
			padding: 8px;
 ...
 <script>
	document.querySelector('.box_profile').removeAttribute('style');
 </script>
</html>
<style>
