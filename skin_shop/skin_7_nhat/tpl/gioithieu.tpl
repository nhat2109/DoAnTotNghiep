...
<head>
    ...
    <script>
        ...
        window.sectionScripts = [
            ...
            "//bizweb.dktcdn.net/100/491/756/themes/956460/assets/quickview.js?1727322848954",

        ]
        window.themeCss = [
            "//bizweb.dktcdn.net/100/491/756/themes/956460/assets/font.css?1727322848954",
            "//bizweb.dktcdn.net/100/491/756/themes/956460/assets/quickviews-popup-cart.css?1727322848954",
...
<script type="text/x-custom-template" data-template="menuMobile">
    ...
    <div class="addThis_listSharing ">
        ...
        <ul class="addThis_lisq ing list-unstyled  d-none d-sm-block">
            ...
            <li class="addThis_item">
                <a class="addThis_item--icon" href="tel:19006750" rel="nofollow">
                    ...
                    <span class="tooltip-text d-none">Gọi ngay cho chúng tôi</span>
                </a>
            </li>
            <li class="addThis_item">
                <a class="addThis_item--icon" href="https://zalo.me/834141234794359440" target="_blank" rel="nofollow">
                    <img class="img-fluid"
                        ...
                        alt="Gọi ngay cho chúng tôi" loading="lazy" width="44" height="44" />
                    <span class="tooltip-text d-none">Chat với chúng tôi qua Zalo</span>
                </a>
            </li>
            ...
            <li class="addThis_item">
                <a class="addThis_item--icon" href=" https://m.me/" target="_blank" rel="nofollow">
                    ...
                    <span class="tooltip-text d-none">Chat với chúng tôi qua Messenger</span>
                </a>
            </li>
