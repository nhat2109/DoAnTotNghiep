...
<body id="template-collection">
			...
			<div id="logo">
				<a href="/" class="logo-wrapper">
					<img class="img-fluid"
						...
						alt="logo EGA Furniture" width="134" height="45" />
				</a>
			</div>
				...
				<div class="navigation-wrapper navigation-horizontal-wrapper">
					<nav>
						<ul class="navigation navigation-horizontal list-group list-group-flush scroll">
							<li class="menu-item list-group-item">
								...
								<div class="submenu scroll mega-menu">
									...
									<ul class="submenu__list container">
										...
										<li class="submenu__col">
											<span class="submenu__item submenu__item--main">
												<a class="link" href="/den-trang-tri" title="Đèn trang trí">Đèn trang
													trí</a>
											</span>
											...
											<span class="submenu__item submenu__item">
												<a class="link" href="/" title="Phụ kiện chống sét">Phụ kiện chống
													sét</a>
											</span>
										</li>
										...
										<li class="submenu__col">
											<span class="submenu__item submenu__item--main">
												<a class="link" href="/tu-giay-tu-trang-tri"
													title="Vật dụng trong nhà">Vật dụng trong nhà</a>
											</span>
											...
											<span class="submenu__item submenu__item">
												<a class="link" href="/" title="Móc và giá treo áo">Móc và giá treo
													áo</a>
											</span>
											...
											<span class="submenu__item submenu__item">
												<a class="link" href="/" title="Chân nến và đèn lồng">Chân nến và đèn
													lồng</a>
											</span>
										...
										<li class="submenu__col">
											...
											<span class="submenu__item submenu__item">
												<a class="link" href="/" title="MỚI! Nâng cao nỗi nhớ">MỚI! Nâng cao nỗi
													nhớ</a>
											</span>
							...
							<li class="menu-item list-group-item">
								<a href="/collections/all" class="menu-item__link" title="Phòng">
									<span> Phòng</span>
							...
							<li class="menu-item list-group-item">
								<a href="/flashsale" class="menu-item__link" title="Khuyến mãi">
									<span> Khuyến mãi</span>
								</a>
							</li>

							<li class="menu-item list-group-item">
								<a href="/tin-tuc" class="menu-item__link" title="Góc cảm hứng">
			...
			<div class="header-right ega-d--flex">
				...
				<div class="icon-action header-right__icons" style="--header-grid-template: repeat(3, 1fr)">
					<span class="header-icon icon-action__search icon-action__search--desktop toggle_form_search">
						<img src="//bizweb.dktcdn.net/100/491/756/themes/956460/assets/icon-search.png?1727322848954"
							alt="icon-search" />
					</span>
					<div id="icon-account" class="ega-color--inherit header-icon icon-account d-none d-lg-block">
						<img src="//bizweb.dktcdn.net/100/491/756/themes/956460/assets/icon-account.png?1727322848954"
							alt="icon-account" />
					...
					<div class="mini-cart text-xs-center">
						<a class="header-icon cart-count ega-color--inherit" href="/cart" title="Giỏ hàng">
							<img src="//bizweb.dktcdn.net/100/491/756/themes/956460/assets/icon-cart.png?1727322848954"
								alt="icon-cart" />
	...
	<div class="collection_banner mb-3 container text-center">
		<a class="banner" href="/san-pham.html" title="Ảnh banner">
			<picture>
				<source media="(min-width: 768px)" srcset="{flashsale_banner}" data-srcset="{flashsale_banner}">
				<source media="(max-width: 767px)" srcset="{flashsale_banner}" data-srcset="{flashsale_banner}">
				<img class=" img-fluid" src="{flashsale_banner}" width="1620" height="257" alt="Ảnh banner">
			</picture>
	...
	<section class="section wrap_background">
		<div class="container">
			<div class="bg_collection section">
				<div class="coll-head">
					<h1 class="title_page collection-title mb-30 pb-3">
						Tất cả sản phẩm
					</h1>
						...
						<div class="sortPagiBar">
							<div class="sort-cate clearfix">
								<div id="sort-by" class="d-flex align-items-baseline">
									...
									<select class="sort-by custom-dropdown__select content_ul" onchange="sortby(this)"
										name="sort">
									...
									<div class="filter-container">
											...
											<div class="aside-content filter-group clearfix scroll">
												<ul style="overflow: visible" class="row">
													...
													<li style="margin: 0 !important;"
														class="filter-item-toggle cursor-pointer">
														Xem thêm <i class="fas fa-chevron-down"></i>
													</li>
												</ul>
											</div>
										...
										<aside class="aside-item sidebar-item filter-tag-style-1">
											...
											<div class="module-content aside-content filter-group scroll">
												<ul class="check-box-list layered-content filter-size s-filter">
													{list_size}
													<li class="filter-item-toggle cursor-pointer">
														Xem thêm <i class="fas fa-chevron-down"></i>
													</li>
				...
				<div class="col-12">
					<div class="related-product">
						...
						<div id="sidebarproduct" class="card border-0 p-3">
							<div
								class="section_prd_feature section products product_related slick-product slickrelated row">
								{list_daxem}
							</div>
						</div>
					</div>
		...
		<div class="modal-dialog modal-md align-vertical" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<a href="/">
						<img loading="lazy" class="img-fluid" src="{modal_header}" alt="welcome popup" width="590"
							height="590" />
					</a>
		...
		<ul class="addThis_listing list-unstyled d-none d-sm-block">
			<li class="addThis_item">
				<a class="addThis_item--icon" href="tel:19006750" rel="nofollow">
					<img class="img-fluid" src="/uploads/minh-hoa/addthis-phone.svg" alt="Gọi ngay cho chúng tôi"
			...
			<li class="addThis_item">
				<a class="addThis_item--icon" href="https://zalo.me/834141234794359440" target="_blank" rel="nofollow">
					<img class="img-fluid" src="/uploads/minh-hoa/addthis-zalo.svg" alt="Gọi ngay cho chúng tôi"
						loading="lazy" width="44" height="44" />
			...
			<li class="addThis_item">
				<a class="addThis_item--icon" href=" https://m.me/" target="_blank" rel="nofollow">
					<img class="img-fluid" src="/uploads/minh-hoa/addthis-messenger.svg"
