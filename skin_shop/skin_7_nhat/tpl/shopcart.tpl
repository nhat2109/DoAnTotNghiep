...
<head>
	...
	<script>
		...
		window.themeCss = [
			"/skin_shop/skin_7_nhat/tpl/css/font.css",
			"/skin_shop/skin_7_nhat/tpl/css/quickviews-popup-cart.css",
...
<body id="template-page.contact">
	...
	<body>
		...
		<div class="container white collections-container margin-bottom-20">
			<div class="white-background">
				...
				<div class="row">
										...
										<div class="header-cart-price" style="">
											<div class="title-cart ">
												<h3 class="text-xs-left">Tổng tiền</h3><a
													class="text-xs-right totals_price_mobile">{tongtien}₫</a>
											</div>
											<div class="checkout">
												<button class="btn-proceed-checkout-mobile" title="Thanh toán ngay"
													type="button"
													onclick="window.location.href='/checkout.html?step=1'">
													<span>Thanh toán ngay</span>
												</button>
											</div>
											<button class="btn btn-proceed-continues-mobile" title="Tiếp tục mua hàng"
												type="button" onclick="window.history.back()">Tiếp tục mua hàng</button>
					...
					<div class="col-xs-3 cart-col-2 thanhtoan_desktop cart-collaterals cart_submit col-md-4">
						<div id="right-affix">
							<div class="each-row">
								<div class="box-style fee">
									<p class="list-info-price"><span>Tạm tính: </span><strong
											class="totals_price price _text-right text_color_right1">{tamtinh}₫</strong>
									</p>
								</div>
								<div class="box-style fee">
								...
								<button
									...
									onclick="window.location.href='/checkout.html?step=1'">Thanh toán ngay</button>
								<button
									class="button btn-proceed-checkout btn btn-large btn-block btn-danger btn-checkouts"
									title="Tiếp tục mua hàng" type="button" onclick="window.history.back()">Tiếp tục mua
									hàng</button>
							</div>
						</div>
					</div>
		...
		<style>
			/* Ẩn phần tử có lớp thanhtoan_desktop trên màn hình nhỏ hơn hoặc bằng 768px (thường là mobile) */
		...
		<script src="/swiper/swiper.min.js?t=1735616868"></script>
		<script type="text/javascript" src="/js/jquery.priceformat.min.js"></script>
		<script type="text/javascript" src="/js/demo_price.js"></script>
		<script type="text/javascript" src="/js/lazyload.min.js"></script>
		<script src="/skin_shop/skin_7_nhat/tpl/js/process.js?t=1735616868"></script>
		...
		<div class="c-menu--slide-left">
			<div class="la-nav-top-login">
				<div class="la-avatar-nav p-relative text-center">
					...
					<img id="close-nav" class="c-menu__close" src="/skin_shop/css/images/ic-close-menu.png?v=508"
						alt="close nav">
				</div>
			...
			<div class="la-scroll-fix-infor-user scroll">
				...
				<div class="la-nav-menu-items">
					...
					<ul class="la-nav-list-items">
						...
						<li class="ng-scope">
							<a href="/gioi-thieu.html" target="">Giới thiệu</a>
						</li>
						<li class="ng-scope">
					...
					<ul class="la-nav-list-items">
						<li class="ng-scope"><a href="san-pham/noi-com-dien.html">Nồi cơm điện</a></li>
						<li class="ng-scope"><a href="san-pham/bep-tu-hong-ngoai.html">Bếp từ, hồng ngoại</a></li>
						<li class="ng-scope"><a href="san-pham/noi-chien--lo-nuong--bep-nuong.html">Nồi chiên - Lò nướng
								- Bếp Nướng</a></li>
						<li class="ng-scope"><a href="san-pham/bep-dien--bep-ga.html">Bếp điện - Bếp ga</a></li>
						<li class="ng-scope"><a href="san-pham/danh-muc-demo.html">Danh mục demo</a></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="actionToolbar_mobile visible-xs d-none ">
			<ul class="actionToolbar_listing">
				...
				<li>
					<a href="https://www.facebook.com/mrtechstore" target="_blank" rel="nofollow noreferrer"
						aria-label="Nhắn tin">
		...
		<script>
			...
			chatbox.setAttribute("page_id", "344265373160890");
...
>
	...
	<div class='menu-overlay'>
		...
		<noscript>
			<link href="/skin_shop/skin_7_nhat/tpl/css/addthis-sharing.css" rel="stylesheet" type="text/css"
				media="all" />
		</noscript>
...
Vui lòng chọn mua thêm sản phẩm`
    ...
    <div class="modal-content "><button type="button" class="close" data-dismiss="modal" data-backdrop="false"
      ...
      <div class="row row-noGutter">
		...
		<link href="/skin_shop/skin_7_nhat/tpl/css/ae-multilang-custom.css" rel="stylesheet" type="text/css"
			media="all" />
