...
<head>
  ...
  <link rel="preload" href="//bizweb.dktcdn.net/100/491/756/themes/956460/assets/mulish-regular.ttf?1727322848954"
  ...
  <link rel="preload" as="style" type="text/css"
    href="/skin_shop/skin_7_nhat/tpl/css/bootstrap-4-3-min.css?t=<?php echo time();?>" onload="this.rel='stylesheet'" />
    <link rel="preload" as="style" type="text/css"
  ...
  <link href="/skin_shop/skin_7_nhat/tpl/css/main.css" rel="stylesheet" />
  ...
  <script>
    ...
    Bizweb.template = "collection.flashsale";
    if (!Bizweb.fbEventId)
  ...
  <script>
    ...
    meta.customer = {
      ...
      last_name: "dang",
      phone: "84704058699",
      email: "dangnhat10102003@gmail.com",
    };
  ...
  <script type="application/ld+json">
      {
        ...
        "itemListElement": [
...

          {
            ...
            "position": 2,
            "item": {
              "@id": "https://ega-furniture.mysapo.net/flashsale",
              "name": "Flash Sale"
            }
          }
        ]
...
<body id="template-collection.flashsale">
...
{box_header}
  ...
  <div style="background: #fcf4eb; padding-bottom: 30px">
    <div class="container flashsale rounded-0" style="--background-color: transparent">
      <div class="d-flex align-items-center flex-column flashsale__header">
        <a class="link" href="/" title="alt">
          <img alt="alt" src="{flashsale_banner}" />
        </a>
    ...
    <section class="section_flashsale flashsale container" style="
  ...
  <script>
    function egaFlashSale() {
      ...
      const getHours = (times) =>
        Math.floor((times % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
      const getMinutes = (times) =>
        Math.floor((times % (1000 * 60 * 60)) / (1000 * 60));
      ...
      function renderCountDown(distance) {
        ...
        let hours = `<div class="ega-badge-ctd__item ega-badge-ctd__h">${getHours(distance) >= 10
          ? getHours(distance)
          : `0${getHours(distance)}`
          }</div>`;
        let minutes = `	<div class="ega-badge-ctd__item  ega-badge-ctd__m">${getMinutes(distance) >= 10
          ? getMinutes(distance)
          : `0${getMinutes(distance)}`
          }</div>`;
        let seconds = `<div class="ega-badge-ctd__item ega-badge-ctd__s">${getSeconds(distance) >= 10
          ? getSeconds(distance)
          : `0${getSeconds(distance)}`
          }</div>`;
        html = [hours, minutes, seconds];
        if (days > 0)
          html.unshift(
            `	<div class="ega-badge-ctd__item ega-badge-ctd__d">${days >= 10 ? days : `0${days}`
            }</div>`
          );
...
${html.join(`	<div class="ega-badge-ctd__colon" > : </div>`)}
      ...
      if (
        type === "hours" &&
        (new Date().getDay() === +activeDay || +activeDay === 7)
      ) {
        // expireTime
  ...
  <script>
    ...
    window.themeScripts.push(
      "/skin_shop/skin_7_nhat/tpl/js/collflashsale.js"
    );
  </script>
      ...
      <div id="mobile-menu" class="scroll">
      	<div class='media d-flex user-menu'>
      		...
      		<div class="media-body d-md-flex flex-column ">
      			...
      			<a rel="nofollow" class="d-block" href="/account" title="Tài khoản">
      				Tài khoản</a>
      			<small>
  ...
  <link rel="stylesheet" href="/skin_shop/skin_7_nhat/tpl/css/sales-pop.css"
...
Vui lòng chọn mua thêm sản phẩm`;
  ...
  <script>
    ...
    filter.addValue("collection", "collections", "3193105", "AND");
  ...
  <script>
    ...
    window["cro-btn"] = {
      ...
      currentTemplate: "collection.flashsale",
      platformApi: Bizweb,
      scripts: [],
      lang: {
  ...
  <div class="popup-sapo">
    ...
    <div class="content">
      ...
      <ul class="">
        <li>
          <a href="socdo.vn" target="_blank" title="Đánh giá sản phẩm" aria-label="Đánh giá sản phẩm">Đánh giá sản
            phẩm</a>
        </li>

        <li>
          <a href="socdo.vn" target="_blank">Ứng dụng Affiliate</a>
        </li>
        <li>
          <a href="socdo.vn" target="_blank"> Đa ngôn ngữ</a>
        </li>
        <li>
          <a href="socdo.vn" target="_blank"> Mua X Tặng Y </a>
        </li>
        <li>
          <a href="socdo.vn" target="_blank">Combo sản phẩm</a>
        </li>
      </ul>
      <div class="ghichu">
