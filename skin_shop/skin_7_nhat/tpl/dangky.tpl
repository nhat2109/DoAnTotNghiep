...
<html lang="vi">                                          
	{header}
	<body id="template-customers/register">
		...
		<div class="wrap_background_aside margin-bottom-40 page_login">
			<div class='heading-bar text-center'>
				...
				<span class="or">Bạn đã có tài khoản ? Đăng nhập
					<a  href="/dang-nhap.html" style="text-decoration: underline;" class="btn-link-style  btn-style margin-right-0">tại đây</a></span>
				...
				<div class="col-12 col-md-6 col-lg-5 offset-md-3 py-3 mx-auto">
					<div class="page-login py-3 ">
						<div id="login">
							...
							<form method="post" action="/account/register" id="customer_register" accept-charset="UTF-8"><input name="FormType" type="hidden" value="customer_register"/><input name="utf8" type="hidden" value="true"/><input type="hidden" id="Token-1e9d39bc84fc461297f7330f24f7eb81" name="Token" /><script src="https://www.google.com/recaptcha/api.js?render=6Ldtu4IUAAAAAMQzG1gCw3wFlx_GytlZyLrXcsuK"></script><script>grecaptcha.ready(function() {grecaptcha.execute("6Ldtu4IUAAAAAMQzG1gCw3wFlx_GytlZyLrXcsuK", {action: "customer_register"}).then(function(token) {document.getElementById("Token-1e9d39bc84fc461297f7330f24f7eb81").value = token});});</script>
...
<style>
	...
	/* Định dạng container và các phần tử xung quanh */
.container.mr-bottom-20 {
    margin-bottom: 20px;
}
...
/* Định dạng cho văn bản phía dưới tiêu đề */
.text-center span {
    font-size: 14px;
    color: #555;
}
...
/* Định dạng cho liên kết "Đăng nhập" và "Quên mật khẩu" */
.btn-link-style {
    color: #007bff;
...
/* Định dạng cho phần không bắt buộc */
.required {
    color: red;
}
