				...
				<div class="col-xs-12">
					<ul class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
						...
						<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
							<strong itemprop="name">Quên mật khẩu</strong>
				...
				<div class="page-login account-box-shadow">
					<div id="recover-password" class="form-signup">
						...
						<div class="action_bottom text-center">
							<button class="btn btn-style btn-blues" style="margin-top: 15px;" type="button"
								name="quen_matkhau">Lấy lại mật khẩu</button>
						</div>
						<div class="clearfix"></div>
						<p class="text-center">
							<a href="/dang-nhap.html" class="btn-link-style">Đăng nhập</a> | <a
								href="/dang-ky.html">Đăng ký</a>
						</p>
					</div>
				</div>
			</div>
...
Vui lòng chọn mua thêm sản phẩm`
      ...
      <div class="row row-noGutter">
		...
		function getDelivery() {
			if (!$('.ega-delivery').length && window.egaDeliveryValid) {
				...
				script.setAttribute('src', '//bizweb.dktcdn.net/100/491/756/themes/956460/assets/delivery-addon.js?1727322848954');
	...
	<script src="//bizweb.dktcdn.net/100/491/756/themes/956460/assets/api-jquery-custom.js?1727322848954"
		type="text/javascript"></script>



	<link rel="preload" as="script" href="//bizweb.dktcdn.net/100/491/756/themes/956460/assets/main.js?1727322848954" />
	<script src="//bizweb.dktcdn.net/100/491/756/themes/956460/assets/main.js?1727322848954"
		type="text/javascript"></script>
	...
	<script>
		...
		const crAddonScript =
			"https://mixcdn.egany.com/themes/cro-btn-builtin/index.min.js";
		window["cro-btn"] = {
...
<style>
	...
	.box_right .list_action {
		...
		flex-wrap: wrap;
		overflow: hidden;
		/* Bố cục hàng ngang trên desktop và tablet */
	}

	.box_right .list_action .action {
		flex: 1 1 calc(16.666% - 10px);
		/* Mỗi action chiếm 1/6 chiều ngang */
		text-align: center;
	}
	...
	.box_right .list_action {
		display: flex;
		flex-wrap: wrap;
		/* Đảm bảo các mục xuống dòng khi không đủ không gian */
		gap: 10px;
	...
	.box_right .list_action .action {
		...
		/* Chiếm 20% chiều ngang trừ khoảng cách */
	...
	@media (min-width: 769px) and (max-width: 1024px) {
		.box_right .list_action .action {
			...
			/* Mỗi mục chiếm 33.33% chiều ngang */
	...
	.box_right .list_action .action {
		flex: 0 0 auto;
		/* Cố định kích thước phần tử */
		width: 150px;
		/* Kích thước cố định cho mỗi action */
	}
</style>
