...
<body id="template-page.contact">
	...
	<section class="page_contact section p-0 m-0">
		<div class="container pb-3 pt-0">
			<div class="row">
				<div class="col-lg-6 col-12">
					<div class="left-contact px-lg-2">
						<h1 class="title_page mb-3 pt-0">{title}</h1>
						...
						<div class="single-contact">
							...
							<div class="content">
								Số điện thoại: <a class="link" title="19006750" href="tel:19006750">{hotline}</a>
							</div>
						</div>
						<div class="single-contact">
							<i class="fa fa-envelope"></i>
							<div class="content">
								Email: <a title="{email}" class="link" href="mailto:{email}">{email}</a>
							</div>
						</div>
						<div id="pagelogin" class="pt-3 mt-3 border-top">
							...
							<form method="post" action="/postcontact" id="contact" accept-charset="UTF-8"><input
									...
									value="true" /><input type="hidden" id="Token-d01bc25bbe4444e290a5bb5bbc4a2fa5"
									name="Token" />
								<script
									src="https://www.google.com/recaptcha/api.js?render=6Ldtu4IUAAAAAMQzG1gCw3wFlx_GytlZyLrXcsuK"></script>
								<script>grecaptcha.ready(function () { grecaptcha.execute("6Ldtu4IUAAAAAMQzG1gCw3wFlx_GytlZyLrXcsuK", { action: "contact" }).then(function (token) { document.getElementById("Token-d01bc25bbe4444e290a5bb5bbc4a2fa5").value = token }); });</script>


								<div class="form-signup clearfix">
									<div class="row group_contact">
										<fieldset class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<input placeholder="Họ tên" type="text" style="font-size: 16px !important;"
												class="form-control  form-control-lg" required value=""
												name="contact[Name]">
										</fieldset>
										<fieldset class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<input placeholder="Email" type="email" style="font-size: 16px !important;"
												pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required id="email1"
												class="form-control form-control-lg" value="" name="contact[email]">
										</fieldset>
										<fieldset class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<input placeholder="Số điện thoại" type="text" style="font-size: 16px !important;"
												class="form-control  form-control-lg" required pattern="\d+"
												name="contact[Phone]" value="">
										</fieldset>
										<fieldset class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<textarea placeholder="Nhập nội dung" name="contact[body]" id="comment" style="font-size: 16px !important;"
