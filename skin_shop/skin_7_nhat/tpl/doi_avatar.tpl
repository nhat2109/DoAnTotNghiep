            ...
            <div class="col-xs-12">
                <ul class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                        <strong itemprop="name">Đổi ảnh đại diện</strong>
        ...
        <div class="container_member">
            ...
            <div class="box_right">
                <div class="list_action">
                    ...
                    <div class="action">
                        <a href="/doi-avatar.html" class="active">
                ...
                <div class="box_profile" style="width: 420px;">
                    ...
                    <div class="li_input">
                        <div class="col_100" style="text-align: center;">
                            <button type="button" name="change_avatar">Lưu thay đổi</button>
                        </div>
                    </div>
                </div>
            </div>
