...
<head>
	...
	<link rel="preload" as="style" type="text/css"
		...
		<link href="/skin_shop/skin_7_nhat/tpl/css/product-style.css" rel="stylesheet"
	...
	<script>
		...
		Bizweb.id = 491756;
		Bizweb.theme = { "id": 956460, "name": "EGA Furniture_v1.0_20240806", "role": "main" };
	...
	<script>
		(function () {
			function asyncLoad() {
				var urls = ["/skin_shop/skin_7_nhat/tpl/js/productreviews.min.js", "/skin_shop/skin_7_nhat/tpl/js/scripttag.js", "/skin_shop/skin_7_nhat/tpl/js/script.v2.js", "/skin_shop/skin_7_nhat/tpl/js/script.js"];
	...
	<script type="application/ld+json">
      ...
      
      {
                ...
                "item": 
                {
                  "@id": "https://ega-furniture.mysapo.net/lien-he",
                  "name": "Liên hệ"
                }
            }
	...
	<!--
			...
			---------------------------------------
		-->
	<script>var ProductReviewsAppUtil = ProductReviewsAppUtil || {}; ProductReviewsAppUtil.store = { name: 'EGA Furniture' };</script>
			...
			<div class="row">
				<div class="col-12 a-left">
					<ul class="breadcrumb m-0 px-0 py-2">
						...
						<li>
							<strong><span>{tieu_de}</span></strong>
		...
		<div class="mobile-menu-body scroll">
			<nav>
				<ul class="navigation navigation-horizontal list-group list-group-flush scroll">
					...
					<li class="menu-item list-group-item">
						...
						<div class="submenu scroll  mega-menu ">
							...
							<ul class="submenu__list container">
								...
								<li class="submenu__col">
									<span class="submenu__item submenu__item--main">
										<a class="link" href="/tu-giay-tu-trang-tri" title="Vật dụng trong nhà">Vật dụng
											trong nhà</a>
									</span>
					...
					<li class="menu-item list-group-item">
						<a href="https://wiki.egany.com/s/ega-furniture-sapo" target="_blank" class="menu-item__link"
...
<a href="/collections/all" 
   ...
   title="Phương thức thanh toán">
	<img class=" img-fluid" loading="lazy"
		 src="//bizweb.dktcdn.net/100/491/756/themes/956460/assets/footer_trustbadge.png?1727322848954" 
