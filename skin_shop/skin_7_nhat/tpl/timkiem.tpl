  ...
  <script type="application/ld+json">
      {
        ...
        "itemListElement": [
...

          {
            ...
            "position": 2,
            "item": {
              "@id": "https://ega-furniture.mysapo.net/search",
              "name": "Tìm kiếm"
            }
          }
        ]
...
<body id="template-search">
  ...
  <section class="signup section search-main wrap_background background_white">
    <div class="container card py-3 mb-4">
      <div class="search-type-tabs mx-auto" style="display: none">
        <ul class="tabs tabs-title list-unstyled mt-2 mt-sm-0 mb-0 tabs-group d-flex justify-content-center">
          <li class="tab-link px-3 py-2 link" data-tab="product">Sản phẩm</li>
          <li class="tab-link px-3 py-2 link ml-2" data-tab="article">
            Bài viết
          </li>
        </ul>
      </div>
      <div class="row" id="search-result">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-bottom-15 mt-3">
          <h1 class="title-head">Có {total_sanpham} kết quả tìm kiếm phù hợp</h1>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-bottom-30">
          <div class="products-view-grid products cls_search list_hover_pro">
          ...
          <!-- <div class="col-12 text-center">
            <nav class="clearfix relative nav_pagi w_100">
              <ul class="pagination clearfix float-right">
                ...
                <li class="page-item">
                  <a class="page-link" href="/search?type=product%2Carticle&active_tab=product&query=sofa&page=2">2</a>
                </li>
                <li class="page-item">
                  <a class="page-link" href="/search?type=product%2Carticle&active_tab=product&query=sofa&page=3">3</a>
                </li>

                <li class="page-item hidden-xs">
                  <a class="page-link" href="/search?type=product%2Carticle&active_tab=product&query=sofa&page=2"><i
  ...
  <noscript>
    <link href="/skin_shop/skin_7_nhat/tpl/css/addthis-sharing.css" rel="stylesheet"
      type="text/css" media="all" />
  </noscript>
...
Vui lòng chọn mua thêm sản phẩm`;
  ...
  <script>
    ...
    if (
      EGASmartSearchConfigs.displayArticle &&
      searchType &&
...
<style>
  ...
  .slickthumb_relative_product_1,.custom-slider-nav{
