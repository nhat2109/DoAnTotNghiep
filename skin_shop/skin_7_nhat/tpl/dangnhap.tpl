...
<html lang="vi">                                          
{header}
	<body id="template-customers/login">
				...
				<div id="login">
					...
					<div class="form-signup clearfix">
						<fieldset class="form-group margin-bottom-20">
							...
							<span  style="float: left;" class="error-message" id="email-error"></span>
						</fieldset>
						<fieldset class="form-group">
							...
							<span style="float: left;" class="error-message" id="password-error"></span>
						</fieldset>
...
/* Định dạng cho các phần tử row và col */
.row {
    display: flex;
...
/* Định dạng cho hộp đăng nhập ở desktop */
.page-login {
...
/* Định dạng cho hộp đăng nhập ở mobile */
...
/* Định dạng cho liên kết "Quên mật khẩu" */
.btn-link-style {
    color: #007bff;
...
/* Định dạng cho các phần tử khác */
.pull-xs-left {
    text-align: left;
}
			...
			<div class="heading-bar text-center">
					<h1 class="title_page mb-0">Đăng nhập tài khoản</h1>
													<p class="mb-0">Bạn chưa có tài khoản ?
														<a  href="/dang-ky.html" class="btn-link-style btn-register" style="text-decoration: underline; "> Đăng ký tại đây</a></p>
			</div>
			<div class="row">
					...
					<div class="page-login ">
						<div id="login" >
							...
							<div class="form-signup clearfix">
								<fieldset class="form-group">
									...
									<input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" class="form-control " value="" name="email" id="customer_email" placeholder="Email" Required>
								</fieldset>
								<fieldset class="form-group">
									<label>Mật khẩu <span class="required">*</span> </label>
									<input type="password" class="form-control " value="" name="password" id="customer_password" placeholder="Mật khẩu" Required>
								     <small class="d-block my-2">Quên mật khẩu? Nhấn vào<a href="#" class="btn-link-style text-primary"  onclick="showRecoverPasswordForm();return false;"> đây </a></small>
								</fieldset>

								<div class="pull-xs-left button_bottom a-center  mb-3">
									<button class="btn btn-block btn-style  btn-login"  type="submit" value="Đăng nhập">Đăng nhập</button>
						...
						<div id="recover-password" style="display:none;"  class="form-signup page-login text-center">
							...
							<div class="action_bottom my-3">
								<button class="btn btn-style btn-recover btn-block" type="submit">Lấy lại mật khẩu</button>
                            	<a href="#" class="btn btn-style link btn-style-active " onclick="hideRecoverPasswordForm();return false;">Quay lại</a>
...
<link rel="stylesheet" href="//bizweb.dktcdn.net/100/491/756/themes/956460/assets/sales-pop.css?1727322848954" media="print" onload="this.media='all'">
