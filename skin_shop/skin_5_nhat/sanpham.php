...
$da_xem = $_SESSION['daxem'] ?? [];
$list_id=implode(",",$da_xem);
...
$replace=array(
	...
	'list_daxem'=>$class_index->list_sanpham_daxem($conn,$s,$r_shop['user_id'],$list_id,'',$list_muakem_id,$list_tang_id,$list_flashsale_id,$list_c,10),
...
echo $skin->skin_replace('skin_shop/'.$s.'/tpl/sanpham',$replace);
?>