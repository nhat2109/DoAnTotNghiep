...
<head>
    ...
    <link rel="preload" as="style" type="text/css" href="/skin_shop/skin_5_nhat/tpl/css/bootstrap.css?t=<?php echo time();?>" onload="this.rel='stylesheet'" />
    <link href='/skin_shop/skin_5_nhat/tpl/css/bootstrap.css?t=<?php echo time();?>' rel='stylesheet' type='text/css' media='all' />
    <link rel="preload" as="style" type="text/css" href="/skin_shop/skin_5_nhat/tpl/css/base.css?t=<?php echo time();?>" onload="this.rel='stylesheet'" />
    <link href='/skin_shop/skin_5_nhat/tpl/css/base.css?t=<?php echo time();?>' rel='stylesheet' type='text/css' media='all' />
    <link rel="preload" as="style" type="text/css" href="/skin_shop/skin_5_nhat/tpl/css/styles.css?t=<?php echo time();?>" onload="this.rel='stylesheet'" />
    <link href='/skin_shop/skin_5_nhat/tpl/css/styles.css?t=<?php echo time();?>' rel='stylesheet' type='text/css' media='all' />
    ...
    <style type="text/css">
        ...
        .box_flash_sale .box_title h2, .box_flash_sale .box_title, .container_title, .header nav{
        ...
        .testimonial-section .testimonial-header,  .footer .tt-footer-default{
        ...
        .footer .copyright{
            background: {bg_bottom_footer} !important;
            color: {color_text_bottom_footer} !important;
        }
