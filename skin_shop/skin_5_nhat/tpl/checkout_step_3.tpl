...
<head>
    ...
    <meta name="description" content="Tổng kho hàng - Đơn hàng#{ma_don}">
    <style>
        .btn {
        ...
        .checkmark {
            ...
            box-shadow: 0 0 0 rgba(76, 175, 80, .3);
...
<body style="">
    ...
    <button class="order-summary-toggle order-summary-toggle-hide">
        <div class="wrap">
            <div class="order-summary-toggle-inner">
                ...
                <div class="order-summary-toggle-total-recap" data-checkout-payment-due-target="{tongtien}">
        ...
        <div class="wrap">
                    ...
                    <div class="order-summary order-summary-is-collapsed">
                        ...
                        <div class="order-summary-sections">
                            ...
                            <div class="order-summary-section order-summary-section-total-lines payment-lines"
                                ...
                                <div>
                                    <a href="/" style="float: inline-end !important; margin: 40px 0 0 0;"
                                        class="step-footer-continue-btn">
            ...
            <div class="main">
                <!-- <div class="main-header">
                    <a href="/" class="logo">
                        <h1 class="logo-text">Tổng kho hàng</h1>
                    </a>
                </div> -->
                <style>
                    a.logo {
                    ...
                    <div>
                        <div class="section">
                            <div class="section-header os-header">
                                <svg width="60" height="60" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    stroke="#4CAF50" stroke-width="2" class="checkmark">
                                    <path class="checkmark_circle"
                                        d="M30 58c15.464 0 28-12.536 28-28S45.464 2 30 2 2 14.536 2 30s12.536 28 28 28z">
                                    </path>
                        ...
                        <div class="step-footer">
                            ...
                            <p class="step-footer-info">
                                ...
                                <span>Cần hỗ trợ? <a href="/lien-he.html">Liên hệ chúng tôi</a></span>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="/skin_shop/skin_test_phanloai/tpl/js/process.js"></script>
