...
<head>
    ...
    <style>
        ...
        .icon.icon-clear {
            ...
            height: 16px;
            border-radius: 50%;
            background-image: url('data:image/svg+xml;base64,'), none;
        }
        ...
        /* CSS tinh gọn cho phương thức thanh toán và ghi chú */
        .section-content {
            width: 100%;
            max-width: 100%;
            padding: 0;
        ...
        .radio-input .input-radio:checked {
            border-color: #338dbc;
            box-shadow: 0 0 0 3px #338dbc inset;
            background: #fff;
        }
...
<body>
                        ...
                        <div class="order-summary-sections">
                            ...
                            <div class="order-summary-section order-summary-section-total-lines payment-lines"
                                    ...
                                    <tbody>
                                        <tr class="total-line total-line-subtotal">
                                            ...
                                            <td class="total-line-price">
                                                <span class="order-summary-emphasis">{tamtinh}₫</span>
                                            </td>
                                        </tr>
                                ...
                                <div class="sidebar-footer">
                                    ...
                                    <a class="sidebar-footer-previous-link" href="/gio-hang.html">Giỏ hàng</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="step-sections" step="1">
                            ...
                            <div class="section">
                                ...
                                <div class="section-content">
                                    ...
                                    <div class="field field-show-floating-label">
                                        <div class="field-input-wrapper">
                                            <label class="field-label" for="ghi_chu"></label>
                                            <textarea placeholder="Nhập ghi chú nếu có" class="field-input"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var selectedProvince = $provinceSelect.attr('value');
            if (selectedProvince) {
                $provinceSelect.val(selectedProvince);
                $provinceSelect.trigger('change');
                setTimeout(() => {
                    var selectedDistrict = $districtSelect.attr('value');
        ...
        $(document).ready(function() {
            ...
            var payment_due_price = $('.payment-due-price');
            districtSelect_huyen.on('change', function () {
                var tinhValue = provinceSelect_tinh.val();
