                        ...
                        <div class="clearfix padding-bottom-10">
                            ...
                            <div class="col-xs-12 col-sm-6 col-lg-6 col-md-6 details-pro">
                                ...
                                <div class="inventory_quantity">
                                    ...
                                    <span class="a-stock">
                                        <link itemprop="availability" href="http://schema.org/InStock" />{tinh_trang}</span>
                                </div>
                                ...
                                <div class="form-product">
                                    ...
                                    <div class="form-group ">
                                        <div class="custom custom-btn-number form-control">
                                            ...
                                            <button onclick="var result = document.getElementById('quantity_view'); var qty = result.value; if( !isNaN(qty) & qty > 1 ) result.value--;return false;" class="btn-minus btn-cts" type="button">–</button>
                                            <input type="text" class="qty input-text" id="quantity_view" name="quantity" size="4" value="1" />
                                            <button onclick="var result = document.getElementById('quantity_view'); var qty = result.value; if( !isNaN(qty)) result.value++;return false;" class="btn-plus btn-cts" type="button">+</button>
                                        </div>
                                        <div style="clear: both;"></div>
                                        {box_flash_sale}
                                        <div class="clearfix margin-bottom-20"></div>
                                        <div class="clearfix">
                                            <button type="submit" class="btn btn-lg btn-gray btn-cart btn_buy add_to_cart {disabled}" sp_id="{sp_id}" loai="{loai}">
